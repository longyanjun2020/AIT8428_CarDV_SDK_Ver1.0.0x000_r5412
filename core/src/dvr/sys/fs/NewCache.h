...
//int NewCache_Update(FS_CACHE_INFO	*pFSCacheInfo, MMP_UBYTE Unit, MMP_UBYTE u8CacheIndex, MMP_ULONG u32CachesizeAlignSectorNO, MMP_USHORT u16ActualRWSectorNum, void *pBufer );
