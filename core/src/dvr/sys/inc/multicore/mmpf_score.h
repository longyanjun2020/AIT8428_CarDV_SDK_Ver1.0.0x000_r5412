...
#define SCORE_DBG(str)			//__UartWrite(str)
#define SCORE_LOG(str)			//__UartWrite(str)
...
#define SCORE_TASK_RECOG_PRIO       (8)
#define SCORE_TASK_RECOG_ROUTINE_PRIO       (9)
...
#define SCORE_TASK_AUDRECOG_STK_SIZE    (1024)
#define SCORE_TASK_AUDRECOG_ROUTINE_STK_SIZE    (1024)
