...
MMP_ERR MMPF_USBH_UpdPtrAftJpgWiFiDone(void);
MMP_ERR MMPF_USBH_UpdPtrAftJpgDecDone(void);
...
MMP_ERR MMPF_USBH_BulkIn_RegisterTriggerMJPGDecCB(void *pTriggerMJPGDecFunc);
MMP_ERR MMPF_USBH_BulkIn_TriggerMJPG2Preview(MMP_ULONG ulmDecJpgInpQHdlRd);
#if (AIT_REAR_CAM_VR_CAPTURE_EN)
MMP_ERR MMPF_USBH_BulkIn_StartMJPG2VRCapture(void);
MMP_ERR MMPF_USBH_BulkIn_TriggerMJPG2VRCapture(MMP_ULONG ulmDecJpgInpQHdlRd);
#endif
#endif
