...
#if (SUPPORT_VENDOR_REQUEST_FUNC)
typedef void (*CUSTOMER_DATA_HANDLER_CB) (MMP_UBYTE *pData, MMP_USHORT usLen);
#endif
...
#define MSDC_AIT_SCSI_SF_PROTECT_ENABLE         (0x12)
#define MSDC_AIT_SCSI_SF_PROTECT_DISABLE		(0x13)
...
extern void    UsbDmaTxConfig(MMP_ULONG endpoint,MMP_ULONG fb_addr,MMP_USHORT pkt_byte,MMP_USHORT last_pkt_byte,MMP_ULONG pkt_sum,MMP_ULONG zero_end);
extern void    UsbDmaRxConfig(MMP_ULONG endpoint,MMP_ULONG fb_addr,MMP_USHORT pkt_byte,MMP_USHORT last_pkt_byte,MMP_ULONG pkt_sum);
...
#endif
#if (SUPPORT_VENDOR_REQUEST_FUNC)
void MMPF_USB_Customer_Data_Handler_Register_CB(CUSTOMER_DATA_HANDLER_CB OUTcb, CUSTOMER_DATA_HANDLER_CB INcb);
#endif
