...
void    MMPF_USB_HandleVendorReq(void);
void    MMPF_USB_HandleVendorInReq(void);
void    MMPF_USB_HandleVendorOutReq(void);
#endif
...
#if (SUPPORT_VENDOR_REQUEST_FUNC)
extern  void    MMPF_USB_HandleVendorReq(void);
extern  void    MMPF_USB_HandleVendorInReq(void);
extern  void    MMPF_USB_HandleVendorOutReq(void);
#endif
