...
typedef enum _MMPF_USBUVC_H264EVENT {
    USBUVC_H264_EVENT_NONE = 0,
    USBUVC_H264_EVENT_ENCODE_START,
    USBUVC_H264_EVENT_ENCODE_STOP,
    USBUVC_H264_EVENT_NUM
} MMPF_USBUVC_H264EVENT;

typedef void (MMPF_USBUVC_H264Callback) (void);
...
typedef __packed struct _MMPF_USBUVC_CS_DATA_32_CFG {
...
typedef __packed struct _EZ_MODE_IQ_DATA_BUF
{
...
void usb_uvc_ibc_frmRdy_callback(MMP_UBYTE ubIBCPipe, MMP_UBYTE ubUsageId);
