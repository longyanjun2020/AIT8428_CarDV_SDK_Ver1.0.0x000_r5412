...
typedef __packed struct {
    ...
    MMP_UBYTE ubExtraData[2];       ///< 2 bytes for ADPCM
} AVI_ADPCM_FORMAT;
/**
...
//
//==============================================================================
MMP_ERR MMPF_AVIMUX_PreProcessFile(MMP_UBYTE storagemode, MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_AddChunkPrefix(MMP_UBYTE chunktype, MMP_ULONG framesize, MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_AddChunkSuffix(MMP_UBYTE chunktype, MMP_ULONG framesize, MMPF_CONTAINER_INFO* pContainer);
MMP_ULONG MMPF_AVIMUX_CalcChunkPrefixSize(MMP_UBYTE chunktype, MMP_ULONG framesize, MMPF_CONTAINER_INFO* pContainer);
MMP_ULONG MMPF_AVIMUX_CalcChunkSuffixSize(MMP_UBYTE chunktype, MMP_ULONG framesize, MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_KeepSubIndexEntry(MMP_UBYTE chunktype, MMP_ULONG framesize, VIDENC_FRAME_TYPE frametype, MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_AddSubIndexChunk(MMPF_CONTAINER_INFO* pContainer);

MMP_ERR MMPF_AVIMUX_GetRecordingSize(MMP_ULONG *ulSize, MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_PostProcessFile(MMP_UBYTE storagemode, MMP_UBYTE * tmp_buf, MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_GetSavedSize(MMP_ULONG AVSize, MMP_ULONG VideoCount, MMP_ULONG AudioSampleCount, MMP_ULONG AudioChunkCount, MMP_ULONG64 *total_size, MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_FillTail(MMPF_CONTAINER_INFO* pContainer);
MMP_ERR MMPF_AVIMUX_InsertDupFrame(MMPF_CONTAINER_INFO* pContainer);
