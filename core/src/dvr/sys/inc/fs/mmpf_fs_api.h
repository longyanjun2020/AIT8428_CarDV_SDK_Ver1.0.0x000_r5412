...
void MMPF_FS_TestFSAccess(void);
void MMPF_FS_TestFSAccess1(void);
void MMPF_FS_TestFSAccess2(void);
void MMPF_FS_TestFSAccess3(void);
...
void MMPF_FS_Unmount(const MMP_BYTE *sVolume);
MMP_ERR MMPF_FS_Format(const MMP_BYTE *pDevice);
MMP_ERR MMPF_FS_SetClearCachePeriod(MMP_ULONG ulFileID, MMP_ULONG ulSize);
