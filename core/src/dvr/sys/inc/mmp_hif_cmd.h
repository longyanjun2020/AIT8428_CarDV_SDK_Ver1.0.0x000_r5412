...
#define     LINK_GRA2STILLJPEG_SONIX                SUB(0x10)
#define     UNLINK_GRA2STILLJPEG_SONIX              SUB(0x11)
...
#define     START_VMD                              SUB(0x04)
#define		VMD_RUN_ON_CPUA							SUB(0x10)
#define		VMD_RUN_ON_CPUB							SUB(0x20)
...
#define		START_ADAS								SUB(0x04)
#define		ADAS_RUN_ON_CPUA						SUB(0x10)
#define		ADAS_RUN_ON_CPUB						SUB(0x20)
#define HIF_FCTL_CMD_AUDRECOG               (GRP_FLOWCTL | FUNC(0x1C))
#define     INIT_AUDRECOG                           SUB(0x00)
#define     START_AUDRECOG                          SUB(0x01)
#define     SET_AUDRECOG_BUF                        SUB(0x02)
#define		AUDRECOG_RUN_ON_CPUB					SUB(0x20)
...
#define HIF_DSC_CMD_TAKE_JPEG_NO_TRIG_SRC   (GRP_DSC | FUNC(0x14))
#define HIF_DSC_CMD_JPEG_CTRL         		(GRP_DSC | FUNC(0x15))
#define		PAUSE_PREVIEW							SUB(0x01)
#define		RESUME_PREVIEW							SUB(0x02)
#define HIF_DSC_CMD_THUMB_JPEG_SAVE_CARD	(GRP_DSC | FUNC(0x16))
...
#define     EMERGFILE_SIZE_LIMIT                    SUB(0x29)
...
#define     MERGER_MULTIENC_STOP					SUB(0x0E)
#define     MERGER_UVCRECD_FORMAT					SUB(0x0F)
#define     MERGER_UVCRECD_RESOLUTION               SUB(0x10)
#define     MERGER_ENCODE_FRAMERATE					SUB(0x11)
#define     MERGER_UVCRECD_GOP						SUB(0x12)
#define     MERGER_UVCRECD_SPSPPSHDR                SUB(0x13)
#define     MERGER_SET_THUMB_INFO                   SUB(0x14)
#define     MERGER_SET_THUMB_BUF                    SUB(0x15)
#define     MERGER_SEI_MODE                         SUB(0x16)
#define     MERGER_TIME_FLUSH_FSCACHE               SUB(0x17)
#define     MERGER_REFIX_VIDRECD                    SUB(0x18)
#define     MERGER_UVCEMERG_ENABLE                  SUB(0x19)
#define     MERGER_MULTISTREAM_USEMODE              SUB(0x1A)
#define     MERGER_UVCRECD_OPEN_FILE				SUB(0x1B)
#define     MERGER_ALL_START                        SUB(0x1C)
#define     MERGER_DUAL_ENABLE                      SUB(0x1D)
#define     MERGER_UVCRECD_SUPPORT                  SUB(0x1E)
#define     MERGER_DUALEMERG_ENABLE                 SUB(0x1F)
#define     MERGER_MUXER_3GP_CONSTANT_FPS           SUB(0x20)
#define     MERGER_AVSYNC_METHOD					SUB(0x21)
...
#define     ENCODE_PROFILE                          SUB(0x02)
#define     ENCODE_GOP                              SUB(0x03)
#define     ENCODE_FORMAT                           SUB(0x04)
#define     ENCODE_QUALITY_CTL                      SUB(0x05)
#define     GET_VIDRECD_STATUS                      SUB(0x06)
#define		REG_STORE_BUF_INFO						SUB(0x07)
#define		ENCODE_FRAME_RATE						SUB(0x08)
#define		DVS_CONFIG       						SUB(0x09)
#define		DVS_BUF_CACHABLE                        SUB(0x0A)
#define		DVS_ME_ENABLE                           SUB(0x0B)
#define     ENCODE_TIMER_EN                         SUB(0x0C)
#define     SET_HEADER_BUF                          SUB(0x0D)
#define     GET_HEADER_INFO                         SUB(0x0E)
#define     SET_QP_BOUNDARY                         SUB(0x0F)
#define     ENCODE_CROPPING                         SUB(0x10)
#define     SETUP_ME                                SUB(0x11)
#define     ENCODE_PADDING                          SUB(0x12)
#define     ENCODE_BYTE_COUNT                       SUB(0x13)
#define     SET_UVC_HDRBUF                          SUB(0x14)
#define     ENCODE_BIT_RATE                         SUB(0x15)
#define     ENCODE_CAPABILITY                       SUB(0x16)
#define     ENCODE_CURBUFMODE                       SUB(0x17)
#define     ENCODE_INITMOD                          SUB(0x18)
#define     ENCODE_BSBUF                            SUB(0x19)
#define     ENCODE_MISCBUF                          SUB(0x1A)
#define     ENCODE_REFGENBD                         SUB(0x1B)
#define     SNR_FRAME_RATE                          SUB(0x1C)
#define		UPD_ENC_FRAME_RATE                      SUB(0x1D)
#define     MERGER_STATUS                           SUB(0x1E)
#define     GET_VIDRECD_NUMOPEN						SUB(0x1F)
#define     ENCODE_FORCE_I                          SUB(0x20)
#define     ENCODE_RC_MODE                          SUB(0x21)
#define     ENCODE_RC_SKIP                          SUB(0x22)
#define     ENCODE_RC_SKIPTYPE                      SUB(0x23)
#define     ENCODE_RC_LBS                           SUB(0x24)
#define     ENCODE_TNR_EN                           SUB(0x25)
#define     ENCODE_LEVEL                            SUB(0x26)
#define     ENCODE_ENTROPY                          SUB(0x27)
#define     SET_QP_INIT                             SUB(0x28)
#define     GET_SKIP_THD                            SUB(0x29)
#define     VR_THUMBNAIL_ENABLE                     SUB(0x2A)
#define     VR_THUMBNAIL_GET_STS                    SUB(0x2B)
#define     SET_SRC_PIPE                            SUB(0x2C)
#define     STREAMING_ENC_START                     SUB(0x2D)
#define     STREAMING_ENC_STOP                      SUB(0x2E)
#define     VR_THUMBNAIL_SET_RING_BUF_NUM           SUB(0x2F)
