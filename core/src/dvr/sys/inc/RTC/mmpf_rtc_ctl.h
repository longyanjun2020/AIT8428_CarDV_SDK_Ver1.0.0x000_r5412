...
typedef struct _3RD_PARTY_RTC
{
    ...
    MMP_ERR (*fpMMPF_RTC_AIT_ForceReset)(struct _3RD_PARTY_RTC *);
    MMP_BOOL (*fpMMPF_RTC_AIT_IsValid)(struct _3RD_PARTY_RTC *);
    MMP_BOOL (*fpMMPF_RTC_AIT_Read_SecondsToDate)(struct _3RD_PARTY_RTC *, MMP_ULONG ulSeconds, AUTL_DATETIME *data);    
    MMP_ULONG (*fpMMPF_RTC_AIT_ReadTime_InSeconds)(struct _3RD_PARTY_RTC *);
} THIRD_PARTY_RTC;
...
MMP_ERR MMPF_RTC_CTL_ForceReset(void);
MMP_BOOL MMPF_RTC_CTL_IsValid(void);
MMP_BOOL MMPF_RTC_CTL_Read_SecondsToDate(MMP_ULONG ulSeconds, AUTL_DATETIME *pDate);
MMP_ULONG MMPF_RTC_CTL_ReadTime_InSeconds(void);
