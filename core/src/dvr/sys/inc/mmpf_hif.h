...
#define DSC_FLAG_STILLJPG_FRAMEDONE                 (0x00000002) //(still capture in preview)when frame done trigger, set flag to dsc task to set up time stamp
...
#define JPG_FLAG_LARGECAPTURE                      	(0x00000008) // Call by jpeg capture > scaler width case.
#define JPG_FLAG_PAUSE_PREVIEW                      (0x00000010) 
#define JPG_FLAG_RESUME_PREVIEW                     (0x00000020) 
#define JPG_FLAG_CHK_LIST_TRIG                      (0x00000040)
...
/* Flag for Component Flow Control (Component_Ctl_Flag) */
#define COMPONENT_FLAG_SLEEP                        (0x00000001)
#define COMPONENT_FLAG_CHK_STATE                    (0x00000002)
#define COMPONENT_FLAG_FILL_BUF                     (0x00000004)
#define COMPONENT_FLAG_FILL_BUF_DONE                (0x00000008)
#define COMPONENT_FLAG_EMPTY_BUF                    (0x00000010)
#define COMPONENT_FLAG_EMPTY_BUF_DONE               (0x00000020)
...
extern MMPF_OS_FLAGID   Component_Ctl_Flag;
#endif
