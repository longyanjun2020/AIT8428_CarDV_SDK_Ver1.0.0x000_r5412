 ...
 * Global variable
 *===========================================================================*/ 
AITPS_IRDA  	gIRDA = AITC_BASE_IRDA;
U8				gLastKey = 0;
int    			gpre_ubKeyId = -1;
int				gRepeat_cnt = 0;
MMPF_OS_TMRID	gIRDA_Rel_TMRID = 0xFFFFFFFF;
...
{
	if (0xFFFFFFFF != gIRDA_Rel_TMRID) 
	{
		MMPF_OS_StopTimer(gIRDA_Rel_TMRID, NULL);
		gIRDA_Rel_TMRID = 0xFFFFFFFF;
	}
}
...
void MMPS_IrDA_RelCheck_TMRStart(void)
{
	...
	if (gIRDA_Rel_TMRID >= MMPF_OS_TMRID_MAX) {
