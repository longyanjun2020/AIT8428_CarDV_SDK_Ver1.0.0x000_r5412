...
//------------------------------------------------------------------------------
//  Function    : MMPS_AUI_StartWAVPlay
//------------------------------------------------------------------------------
/**
...
//------------------------------------------------------------------------------
//  Function    : MMPS_AUI_PauseWAVPlay
//------------------------------------------------------------------------------
/**
...
//------------------------------------------------------------------------------
//  Function    : MMPS_AUI_ResumeWAVPlay
//------------------------------------------------------------------------------
/**
...
MMP_ERR MMPS_AUI_StartPlay(MMP_UBYTE* audFmt)
{
    MMP_ULONG volume;
	...
	switch(*audFmt)
	{
		case MMP_AUDIO_MP3_PLAY:
			MMPS_AUI_InitializeMP3Play(&fileinfo, &mp3info);
			//MMPS_AUDIO_GetPlayStatus(&status);
			#if (AUDIO_SET_DB == 0x1)
			MMPS_AUDIO_SetPlayVolumeDb(volume);
			#else
			MMPS_AUDIO_SetPlayVolume(volume, MMP_FALSE);
			#endif
...
MMP_ERR MMPS_AUI_StopPlay(MMP_UBYTE *audFmt)
{
	switch(*audFmt)
	{
		case MMP_AUDIO_MP3_PLAY:
			MMPS_AUI_StopMP3Play();
		break;
		case MMP_AUDIO_WAV_PLAY:
