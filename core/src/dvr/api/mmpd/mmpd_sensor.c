...
@return It reports the status of the operation.
*/
MMP_ERR MMPD_Sensor_SetNightMode(MMP_ULONG ulMode, MMP_ULONG ulMinFPS)
{
    MMPH_HIF_WaitSem(GRP_IDX_FLOWCTL, 0);
    MMPH_HIF_SetParameterL(GRP_IDX_FLOWCTL, 0, ulMode);
	MMPH_HIF_SetParameterL(GRP_IDX_FLOWCTL, 4, ulMinFPS);
