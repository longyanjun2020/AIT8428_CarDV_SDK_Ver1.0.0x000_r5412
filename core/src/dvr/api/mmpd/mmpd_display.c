...
//------------------------------------------------------------------------------
//  Function    : MMPD_Display_WaitRotateDMA
//  Description : 
//------------------------------------------------------------------------------
MMP_ERR MMPD_Display_WaitRotateDMA(MMP_UBYTE ubPipeId)
{
    return MMPF_Display_WaitRotateDMA(ubPipeId);
}

//------------------------------------------------------------------------------
//  Function    : MMPD_Display_ResetRotateDMABufIdx
//  Description : 
//------------------------------------------------------------------------------
/** @brief Reset rotate index

The function reset the rotate buffer index with difference 
@ubType[in] 0: Front cam, 1: Rear Cam
@return It reports the status of the operation.
*/
MMP_ERR MMPD_Display_ResetRotateDMABufIdx(MMP_UBYTE ubCamType)
{
    return MMPF_Display_ResetRotateDMABufIdx(ubCamType);
}
...
//------------------------------------------------------------------------------
//  Function    : MMPD_RGBLCD_GetDotClk
//  Description :
//------------------------------------------------------------------------------
/** @brief: Get the RGB panel Dot clock
*/
MMP_ERR MMPD_RGBLCD_GetDotClk(MMP_ULONG *ulRGBDotClk)
{
	return MMPF_RGBLCD_GetDotClk(ulRGBDotClk);
}
...
//------------------------------------------------------------------------------
//  Function    : MMPD_Display_LockWindow
//  Description :
//------------------------------------------------------------------------------
MMP_ERR MMPD_Display_LockWindow(MMP_DISPLAY_WIN_ID winID)
{
    MMPF_Display_LockWindow(winID);

    return MMP_ERR_NONE;
}

//------------------------------------------------------------------------------
//  Function    : MMPD_Display_UnlockWindow
//  Description :
//------------------------------------------------------------------------------
MMP_ERR MMPD_Display_UnlockWindow(MMP_DISPLAY_WIN_ID winID)
{
    MMPF_Display_UnlockWindow(winID);
...
//------------------------------------------------------------------------------
//  Function    : MMPD_Display_AdjustWinColorMatrix
//  Description : 
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
//  Function    : MMPD_Display_SetYuvAttribute
//  Description : 
//------------------------------------------------------------------------------
MMP_ERR MMPD_Display_SetYuvAttribute(MMP_BYTE ubU2U,
                    				 MMP_BYTE ubV2U,           
                    				 MMP_BYTE ubU2V,
                    				 MMP_BYTE ubV2V,
                    				 MMP_BYTE ubYGain,
...
//------------------------------------------------------------------------------
//  Function    : MMPD_Display_SetFreezeWinEn
//  Description : 
//------------------------------------------------------------------------------
MMP_ERR MMPD_Display_SetFreezeWinEn(MMP_BOOL bEn) 
{
    MMPF_Display_SetFreezeWinEn(bEn);
    return MMP_ERR_NONE;
}

//------------------------------------------------------------------------------
//  Function    : MMPD_Display_GetFreezeWinEn
//  Description : 
//------------------------------------------------------------------------------
MMP_BOOL MMPD_Display_GetFreezeWinEn(void) 
{
    return MMPF_Display_GetFreezeWinEn();
}

//------------------------------------------------------------------------------
//  Function    : MMPD_Display_FreezeWinUpdate
//  Description : 
//------------------------------------------------------------------------------
void MMPD_Display_FreezeWinUpdate(MMP_BOOL PIPEn, MMP_BOOL OVLYEn, MMP_BOOL OSDEn) 
{
    MMPF_Display_FreezeWinUpdate(PIPEn, OVLYEn, OSDEn);
}
