...
extern MMP_ERR MMPD_USB_SetRecdFrmRxTimeoutCFG(MMP_ULONG pulRecdFrmRxLostTH, void *pDevRecdFrmRxLostTHCallback);
...
extern MMP_ERR MMPD_USB_CaptureJpeg(MMP_ULONG ulJpegAddr, MMP_ULONG ulBufSize, MMP_UBYTE ubDelayCnt);
extern MMP_ERR MMPD_USB_QueryJpeg(MMP_ULONG *ulJpegSize);
