...
MMP_ERR MMPD_FS_FileClose(MMP_ULONG ulFileId)
{
	...
	MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_CLOSE | HIF_USR_CMD_FS_ACCESS);
                                ...
                                MMP_ULONG ulNumBytes, MMP_ULONG *ulReadCount)
{
    ...
    *ulReadCount = 0;
    ...
    while (read_size) {
        ...
        MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_READ | HIF_USR_CMD_FS_ACCESS);
                                 ...
                                 MMP_ULONG ulNumBytes, MMP_ULONG *ulWriteCount)
{
    ...
    *ulWriteCount = 0;  //clear
    ...
    while (write_size) {
        ...
        MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_WRITE | HIF_USR_CMD_FS_ACCESS);
...
MMP_ERR MMPD_FS_FileSeek(MMP_ULONG ulFileId, MMP_LONG64 llOffset, MMP_ULONG ulOrigin)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_SEEK | HIF_USR_CMD_FS_ACCESS);
...
MMP_ERR MMPD_FS_FileTell(MMP_ULONG ulFileId, MMP_LONG64 *llFilePos)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_TELL | HIF_USR_CMD_FS_ACCESS);
                         ...
                         MMP_BYTE *bDest,MMP_ULONG ulDestSize)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_COPY | HIF_USR_CMD_FS_ACCESS);
	mmpstatus = MMPH_HIF_GetParameterL(GRP_IDX_USR, 0);
...
MMP_ERR MMPD_FS_FileTruncate(MMP_ULONG ulFileId, MMP_ULONG ulNewSize)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_TRUNCATE | HIF_USR_CMD_FS_ACCESS);
	mmpstatus = MMPH_HIF_GetParameterL(GRP_IDX_USR, 0);
...
MMP_ERR MMPD_FS_FileGetSize(MMP_ULONG ulFileId, MMP_ULONG64 *ulFileSize)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_GET_SIZE | HIF_USR_CMD_FS_ACCESS);
	mmpstatus = MMPH_HIF_GetParameterL(GRP_IDX_USR, 0);
...
MMP_ERR MMPD_FS_FileRemove(MMP_BYTE *bpFileName, MMP_ULONG ulNameSize)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_REMOVE | HIF_USR_CMD_FS_ACCESS);
	mmpstatus = MMPH_HIF_GetParameterL(GRP_IDX_USR, 0);
...
MMP_ERR MMPD_FS_FileDirGetAttribute(MMP_BYTE *bpName, MMP_ULONG ulNameSize, MMPD_FS_ATTRIBUTE *attribute)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_DIR_GETATTRIBUTES | HIF_USR_CMD_FS_ACCESS);
	mmpstatus = MMPH_HIF_GetParameterL(GRP_IDX_USR, 0);
...
MMP_ERR MMPD_FS_FileDirGetInfo(MMP_BYTE *bpName, MMP_ULONG ulNameSize, MMPD_FS_ATTRIBUTE *attribute, MMP_ULONG *ulpTimeStamp, MMP_ULONG *ulpFileSize)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_DIR_GETINFO | HIF_USR_CMD_FS_ACCESS);
...
MMP_ERR MMPD_FS_FileDirGetTime(MMP_BYTE *bpName, MMP_ULONG ulNameSize, MMP_ULONG *ulpTimeStamp)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_DIR_GETTIME | HIF_USR_CMD_FS_ACCESS);
	mmpstatus = MMPH_HIF_GetParameterL(GRP_IDX_USR, 0);
                                   ...
                                   MMP_BYTE *bNameDest,MMP_ULONG ulDestSize)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_DIR_MOVE | HIF_USR_CMD_FS_ACCESS);
                                     ...
                                     MMP_BYTE *bNewName,  MMP_ULONG ulNewNameSize)
{
    ...
    if( gubFormatFreeON == 0 )  //Workaround to avoid too much compare time if too many files,
    #endif
    {
        // Check if bNewName is duplicated to current filenames in SD card
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_DIR_RENAME | HIF_USR_CMD_FS_ACCESS);
...
MMP_ERR MMPD_FS_FileDirSetAttribute(MMP_BYTE *bpName, MMP_ULONG ulNameSize, MMPD_FS_ATTRIBUTE attribute)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_DIR_SETATTRIBUTES | HIF_USR_CMD_FS_ACCESS);
...
MMP_ERR MMPD_FS_FileDirSetTime(MMP_BYTE *bpName, MMP_ULONG ulNameSize, MMP_ULONG ulTimeStamp)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_USR, FS_FILE_DIR_SETTIME | HIF_USR_CMD_FS_ACCESS);
