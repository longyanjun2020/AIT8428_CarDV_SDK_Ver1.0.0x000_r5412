...
__inline MMP_ERR MMPD_Streaming_SetCompBuf(MMP_USHORT usEncID, MMP_USHORT usModeID, MMP_ULONG uladdr, MMP_ULONG ulsize, MMP_M_STREAMCB_CODEC codec)
    										{ return MMPD_MJPEG_SetCompBuf(usEncID, usModeID, uladdr, ulsize, codec); }
MMP_ERR MMPD_Streaming_SetCompBufAttr(MMP_USHORT usEncID, MMP_ULONG (*FrameSizeCalFunc)(MMP_ULONG ulFrameSize),
                                      MMP_USHORT usAlignment);
__inline MMP_ERR MMPD_Streaming_SetLineBuf(MMP_USHORT usEncID, MMP_ULONG uladdr, MMP_ULONG ulsize)
    										{ return MMPD_MJPEG_SetLineBuf(usEncID, uladdr, ulsize); }
__inline MMP_ERR MMPD_Streaming_Enable(MMP_USHORT usEncID, MMP_BOOL bEnable, MMP_BOOL bWaitForSync) 
											{return MMPD_MJPEG_StreamEnable(usEncID, bEnable, bWaitForSync);}

// JPEG Control Function
