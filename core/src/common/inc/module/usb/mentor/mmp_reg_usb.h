...
typedef struct _AITS_USB_EP {
    ...
    AIT_REG_W   USB_EP_RX_CSR;                                  // 0x06
        ...
        #define EP_RX_BULK_USB_ERR      0x0004
    ...
    AIT_REG_W   USB_EP_COUNT;                                   // 0x08
        /*-DEFINE-----------------------------------------------------*/
        #define USB_EP_COUNT_MASK       0x01FFF
        /*------------------------------------------------------------*/
...
typedef struct _AITS_USB_CTL {
    ...
    USB_FIFO_RW USB_FIFO_EP[USB_TOTAL_EP_NUM];                  // 0x20
    ...
    AIT_REG_B   USB_ADT_LINK_INFO;                              // 0x7A
        /*-DEFINE-----------------------------------------------------*/
        #define USB_WTCON_MASK      0xF0
        #define USB_WTID_MASK       0x0F
        /*------------------------------------------------------------*/
    ...
    USB_MULTIPOINT  USB_MP_CTL[USB_TOTAL_EP_NUM];               // 0x80~0xBF
    AIT_REG_B                   _0xC0[0x40];                    // 0xC0~0xFF

    USB_EP_CTL  USB_EP[USB_TOTAL_EP_NUM];                       // 0x100
    AIT_REG_B                  _0x180[0x180];
    AIT_REG_W   USB_EP_RQ_PKT_CNT[USB_TOTAL_EP_NUM];            // 0x300~0x30F
