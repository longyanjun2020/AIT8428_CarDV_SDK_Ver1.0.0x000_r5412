...
MMP_ERR MMPF_IBC_UpdateH264RTSrcPipe(MMP_IBC_PIPEID pipeID);
...
MMP_ERR MMPF_IBC_UpdateStoreEndAddress(MMP_IBC_PIPEID pipeID, MMP_ULONG ulBaseAddr,
                                       MMP_ULONG ulBaseUAddr, MMP_ULONG ulBaseVAddr);
...
MMP_UBYTE MMPF_IBC_MapDispColorToIBCFmt(MMP_UBYTE ubDispColor);
