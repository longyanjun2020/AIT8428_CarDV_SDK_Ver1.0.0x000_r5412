...
MMP_BOOL MMPF_RAWPROC_GetStoreEnable(MMP_UBYTE ubRawId, MMP_UBYTE ubPlane);

// Bayer Function
MMP_ERR MMPF_RAWPROC_SetInterruptForBayerFmt(MMP_UBYTE ubRawId);

// YUV Function
MMP_ERR MMPF_RAWPROC_SetInterruptForYUV420Fmt(MMP_UBYTE ubRawId);
MMP_ERR MMPF_RAWPROC_SetInterruptForYUV422Fmt(MMP_UBYTE ubRawId, MMP_UBYTE ubSnrSel);
MMP_ERR MMPF_RAWPROC_SetDeInterlaceBuf(MMP_UBYTE ubRawId, MMP_UBYTE ubBufIdx, MMP_ULONG ulYAddr, MMP_ULONG ulUAddr, MMP_ULONG ulVAddr, MMP_ULONG ulBufCnt);
MMP_ERR MMPF_RAWPROC_ResetDeInterlaceBufIdx(MMP_UBYTE ubRawId);
MMP_ERR MMPF_RAWPROC_AddGraToPipeInfoToQueue(MMP_UBYTE ubSnrSel, MMP_UBYTE ubRawId);
MMP_ERR MMPF_RAWPROC_TriggerGraToPipe(MMP_UBYTE ubRawId, MMP_BOOL bTrigStart);
MMP_ERR MMPF_RAWPROC_DmaDeInterlace(MMP_UBYTE ubRawId, MMP_UBYTE ubUsageId);
