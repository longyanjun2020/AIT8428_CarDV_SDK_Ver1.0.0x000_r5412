...
typedef struct _AITS_VIF 
{
    ...
    AIT_REG_B   VIF_SENSR_CLK_FREQ [VIF_NUM];                           // 0x82
        /*-DEFINE-----------------------------------------------------*/
        #define VIF_SENSR_CLK_FREQ_MASK		0x1F
        #define VIF_SENSR_CLK_PLL_DIV(_a)   ((_a - 1) & VIF_SENSR_CLK_FREQ_MASK) 
        /*------------------------------------------------------------*/
    ...
    AIT_REG_B   VIF_YUV420_CTL [VIF_NUM];                              	// 0xB4
        ...
        #define VIF_PARA_YUV422_FMT_YUYV	0x00
        #define VIF_PARA_YUV422_FMT_YVYU	0x20
        #define VIF_PARA_YUV422_FMT_UYVY	0x40
        #define VIF_PARA_YUV422_FMT_VYUY	0x60
        /*------------------------------------------------------------*/
...
typedef struct _AITS_MIPI_RX_BIST
{
    ...
    AIT_REG_B							_x81;
    AIT_REG_W	MIPI_RX_BIST_BYTECNT_L;									// 0x82
    AIT_REG_W	MIPI_RX_BIST_BYTECNT_H;									// 0x84
