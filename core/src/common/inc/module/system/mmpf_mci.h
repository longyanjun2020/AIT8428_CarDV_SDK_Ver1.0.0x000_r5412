...
typedef enum _MMPF_MCI_TUNE_MODE {
    ...
    MCI_MODE_RAW                	= MCI_SET_MODE(3),
    MCI_MODE_RAWS0_P0           	= MCI_SET_MODE(3)|MCI_SET_PIPE(0),
    MCI_MODE_RAWS0_P1           	= MCI_SET_MODE(3)|MCI_SET_PIPE(1),
    MCI_MODE_RAWS0_P2           	= MCI_SET_MODE(3)|MCI_SET_PIPE(2),
    MCI_MODE_RAWS0_P3           	= MCI_SET_MODE(3)|MCI_SET_PIPE(3),
    MCI_MODE_RAWS1_P0           	= MCI_SET_MODE(3)|MCI_SET_RAWS(1)|MCI_SET_PIPE(0),
    MCI_MODE_RAWS1_P1           	= MCI_SET_MODE(3)|MCI_SET_RAWS(1)|MCI_SET_PIPE(1),
