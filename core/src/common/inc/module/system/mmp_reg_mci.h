...
#define MCI_SRC_RAWS0                   (10)
#define MCI_SRC_RAWS1_JPGLB             (11)
...
//------------------------------------
// MCI Monitor Structure (0x8000 5900)
//------------------------------------
typedef struct _AITS_MONITOR
{
    AIT_REG_B   MONITOR_EN;                                 // 0x5900
    AIT_REG_B                           _x01;
    AIT_REG_B   MONITOR_INT_CPU_EN;                         // 0x5902
    AIT_REG_B   MONITOR_INT_HOST_EN;                        // 0x5903
        /*-DEFINE-----------------------------------------------------*/
        #define MONITOR_SEG(s)              (1 << s)
        /*------------------------------------------------------------*/
    AIT_REG_B   MONITOR_INT_CPU_SR;                         // 0x5904
    AIT_REG_B   MONITOR_INT_HOST_SR;                        // 0x5905
        /*-DEFINE-----------------------------------------------------*/
        #define MONITOR_INT_SEG_FAULT(s)    (1 << s)
        #define MONITOR_INT_FAULT_MASK      (0xFF)
        /*------------------------------------------------------------*/
    AIT_REG_B                           _x06[10];

    AIT_REG_D   MONITOR_SEG_WR_ALLOW[MCI_MONITOR_SEG_NUM];  // 0x5910~592F
    AIT_REG_D   MONITOR_SEG_RD_ALLOW[MCI_MONITOR_SEG_NUM];  // 0x5930~594F
    AIT_REG_D   MONITOR_SEG_LOW_BD[MCI_MONITOR_SEG_NUM];    // 0x5950~596F
    AIT_REG_D   MONITOR_SEG_UP_BD[MCI_MONITOR_SEG_NUM];     // 0x5970~598F

    AIT_REG_D   MONITOR_SEG_FAULT_SRC[MCI_MONITOR_SEG_NUM]; // 0x5990~59AF  [RO]
    
    AIT_REG_B   MONITOR_SEG_WR_FAULT;                       // 0x59B0       [RO]
    AIT_REG_B   MONITOR_SEG_RD_FAULT;                       // 0x59B1       [RO]
    AIT_REG_B                           _xB2[14];

    AIT_REG_B   MONITOR_SEG_FAULT_CNT[MCI_MONITOR_SEG_NUM]; // 0x59C0~59C7  [RO]
    AIT_REG_B                           _xC8[8];
    
    AIT_REG_D   MONITOR_SEG_FAULT_ADDR[MCI_MONITOR_SEG_NUM];// 0x59D0~59EF  [RO]
} AITS_MONITOR, *AITPS_MONITOR;
#endif
