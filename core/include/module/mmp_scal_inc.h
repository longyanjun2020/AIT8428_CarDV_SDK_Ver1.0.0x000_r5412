...
#define USE_LPF_GRAB_ON_FLAG        (0xAA)
...
typedef struct _MMP_SCAL_IN_MUX_ATTR {
    MMP_BOOL	bFrmSyncEn;
    MMP_UBYTE	ubFrmSyncSel;
} MMP_SCAL_IN_MUX_ATTR;

typedef struct _MMP_SCAL_DELAY {
    MMP_UBYTE   ubPixDelayN;
    MMP_UBYTE   ubPixDelayM;
    MMP_UBYTE   ubLineDelay;
} MMP_SCAL_DELAY;
...
extern const MMP_SCAL_DELAY m_sFullSpeedScalDelay;
