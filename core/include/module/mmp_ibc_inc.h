...
typedef enum _MMP_IBC_LINK_TYPE
{
    ...
    MMP_IBC_LINK_USB            	= 0x0008,
    MMP_IBC_LINK_LDC            	= 0x0010,
    MMP_IBC_LINK_MDTC           	= 0x0020,
    MMP_IBC_LINK_GRA2MJPEG      	= 0x0040,
    MMP_IBC_LINK_GRA2STILLJPG   	= 0x0080,
    MMP_IBC_LINK_WIFI           	= 0x0100,
    MMP_IBC_LINK_GRA2UVC        	= 0x0200,
    MMP_IBC_LINK_MULTIRUNJPEG   	= 0x0400,
    MMP_IBC_LINK_GRA2JPEGQ      	= 0x0800,
	MMP_IBC_LINK_GRA2STILLJPG_SONIX	= 0x1000,
...
typedef struct _MMP_IBC_BUF_ATTR
{
    MMP_UBYTE           ubBufCnt;
    MMP_ULONG           ulBaseAddr[MAX_IBC_PP_BUF_NUM];
    MMP_ULONG           ulBaseUAddr[MAX_IBC_PP_BUF_NUM];
    MMP_ULONG           ulBaseVAddr[MAX_IBC_PP_BUF_NUM];
    MMP_ULONG           ulBaseEndAddr[MAX_IBC_PP_BUF_NUM];
    MMP_ULONG           ulBaseUEndAddr[MAX_IBC_PP_BUF_NUM];
    MMP_ULONG           ulBaseVEndAddr[MAX_IBC_PP_BUF_NUM];
    MMP_ULONG           ulReadyIdx;
    MMP_ULONG           ulUsableIdx;
} MMP_IBC_BUF_ATTR;
