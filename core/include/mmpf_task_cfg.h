...
#define TASK_LDC_CTL_STK_SIZE      	(1024)
#define TASK_COMP_CTL_STK_SIZE      (1024)
#define TASK_H264E_CTL_STK_SIZE     (1024)
#define TASK_SENSOR_STK_SIZE        (1024)
#define TASK_ALGORITHM_STK_SIZE     (768)
...
#define WIFISTREAMCB_STK_SIZE       (1024)  // 512 x4 Bytes
#endif
#if (MP3HD_P_EN == 1)
