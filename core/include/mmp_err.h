...
typedef enum _MMP_MODULE
{
    ...
    MMP_DSC 	= 25,
    MMP_FCTL 	= 26,
    MMP_VCONF 	= 27, //CarDV... No used.  Remove it after AHC_ERR is deleted.
    MMP_3GPPLAY = 28,
    MMP_3GPRECD = 29,
    MMP_UART 	= 30,
    MMP_MDTV 	= 31, //CarDV... No used.  Remove it after AHC_ERR is deleted.
    MMP_SPI 	= 32,
    MMP_PLL 	= 33,
    MMP_USER 	= 34,
    MMP_VT 		= 35, //CarDV... No used.  Remove it after AHC_ERR is deleted.
    MMP_CCIR 	= 36,
    MMP_STORAGE = 37,
    MMP_PIO 	= 38,
    MMP_MFD 	= 39, //CarDV... No used.  Remove it after AHC_ERR is deleted.
    MMP_PWM		= 40,
    MMP_RAWPROC = 41,
    MMP_SIF 	= 42,
    MMP_EVENT 	= 43,
...
typedef enum _MMP_ERR
{
    ...
    MMP_H264ECTL_ERR_QUEUE_OPERATION,
