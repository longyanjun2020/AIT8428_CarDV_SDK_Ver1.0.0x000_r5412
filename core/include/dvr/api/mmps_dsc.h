...
#define DSC_MIN_RAWSTORE_BUF_NUM	(2)
...
{
    MMP_DSC_PATH            sPreviewPath;                                   ///< The preview image pipe path
...
/* MJPEG Function */
MMP_ERR MMPS_DSC_SetVid2MJpegBuf(MMP_ULONG *ulCurBufPos, MMP_USHORT usEncW, MMP_USHORT usEncH, MMP_BOOL bAllocate);
...
MMP_ERR MMPS_DSC_CaptureAfterLdcReady(	MMP_IBC_PIPEID          pipeID,
                                        ...
                                        MMP_SCAL_GRAB_CTRL      *pCaptureGrabctl,
                                        MMP_ULONG              	*pCaptureSize);
typedef struct _MMPS_3GPRECD_STILL_CAPTURE_INFO MMPS_3GPRECD_STILL_CAPTURE_INFO;
