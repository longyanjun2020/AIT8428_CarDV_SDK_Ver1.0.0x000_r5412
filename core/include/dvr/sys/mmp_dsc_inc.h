...
typedef enum _MMP_DSC_JPEG_SETTYPE 
{
	...
	MMP_DSC_JPEGCMD_SETCOMPBUF_ATTR,  		/**< Set compress buffer attribute. This should be used after
												 MMP_DSC_JPEGCMD_SETCOMPBUF. MMP_DSC_JPEGCMD_SETCOMPBUF sets
												 default attributes. */
    ...
    MMP_DSC_JPEGCMD_SETLINEBUF,     			///< Set line buffer info
    MMP_DSC_JPEGCMD_SET_MODEID		    ///< Set MJPG Mode ID	
...
typedef enum _MMP_DSC_JPEG_RC_ID 
{
    ...
    MMP_DSC_JPEG_RC_ID_FRNT_VR_THUMB_RECD,
    MMP_DSC_JPEG_RC_ID_REAR_VR_THUMB_RECD,
    MMP_DSC_JPEG_RC_ID_DUAL_VR_THUMB_RECD,    
    MMP_DSC_JPEG_RC_ID_NONE,
...
// For preview/encode image pipe path Selection
typedef enum _MMP_DSC_PATH {
    MMP_DSC_PATH_2PIPE 			= 0,
    MMP_DSC_PATH_LDC_LB_SINGLE,
    MMP_DSC_PATH_LDC_LB_MULTI,
    MMP_DSC_PATH_LDC_MULTISLICE, 
    MMP_DSC_PATH_INVALID 		= 0xFF
} MMP_DSC_PATH;
