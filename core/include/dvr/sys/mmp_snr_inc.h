...
#define PRM_SENSOR           	    (0)		///< Front Cam Via VIF
#define SCD_SENSOR           	    (1)		///< Rear Cam Via VIF
#define USBH_SENSOR					(2)		///< Rear Cam Via USBH
#define UNDEF_SENSOR			    (0xFF)
#define VIF_SENSOR_MAX_NUM			(2)
#define USBH_SENSOR_MAX_NUM			(1)
#define SENSOR_MAX_NUM        	    (VIF_SENSOR_MAX_NUM + USBH_SENSOR_MAX_NUM)
#define MAX_CAM_NUM                 (SENSOR_MAX_NUM)
...
typedef enum _MMPF_SNR_TVDEC_SRC_TYPE {
    MMP_SNR_TVDEC_SRC_NO_READY = 0,
    MMP_SNR_TVDEC_SRC_PAL,
    MMP_SNR_TVDEC_SRC_NTSC,
    MMP_SNR_TVDEC_SRC_HD,
    MMP_SNR_TVDEC_SRC_FHD,
    MMP_SNR_TVDEC_SRC_NUM
} MMP_SNR_TVDEC_SRC_TYPE;
