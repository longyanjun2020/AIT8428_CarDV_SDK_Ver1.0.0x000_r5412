...
void                MMPF_H264E_Ctl_TaskHandler(void *p_arg);
#endif
#if (SUPPORT_COMPONENT_FLOW_CTL)
void                MMPF_Component_Ctl_TaskHandler(void *p_arg);
#endif
void                MMPF_MP4VENC_TaskHandler(void *p_arg);
void                MMPF_3GPMERGR_TaskHandler(void *p_arg);
#if (SUPPORT_H264_WIFI_STREAM)
void                MMPF_H264WifiStreamCB_TaskHandler(void *p_arg);
#endif
...
void                MMPF_CpuA_Algorithm_TaskHandler(void *p_arg);
void                MMPF_CpuB_Algorithm_TaskHandler(void *p_arg);
#endif
...
#if (SUPPORT_EIS)
void                GYRO_TaskHandler(void *p_arg);
void                EIS_TaskHandler(void *p_arg);
#endif
