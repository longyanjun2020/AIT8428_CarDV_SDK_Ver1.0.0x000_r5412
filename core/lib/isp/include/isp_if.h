...
//black Mask on Luma Shading
void ISP_IF_F_SetLSMask(ISP_UINT8 dist);
ISP_UINT8 ISP_IF_F_GetLSMask(void);
void ISP_IF_F_SetLSMaskEnable(ISP_UINT16 enable);
ISP_UINT8 ISP_IF_F_GetLSMaskEnable(void);
