...
extern int AIT_ADPCMEnc_adpcm_encode_frame(ADPCMCodecContext *avctx, unsigned char *frame, int buf_size, void *data, int FrameCount);
extern  int AIT_ADPCMEnc_adpcm_encode_init(ADPCMCodecContext *avctx);
