 ...
 */
#define GPS_UART_PIN 		(MMP_UART_PADSET_2)// MMP_UART_PADSET_0
...
// UART 2
#if(UART_2_TO_MCU)
#define UART_2_PIN 		(MMP_UART_PADSET_2)
#define UART_2_NUM 		(MMP_UART_ID_2)
#define UART2_MASTER_CLK 		(264000 >> 1) // (clock G0 / 2)
#define UART2_BAUD_RATE 		(115200) //long
...
void uart_to_mcu(void); // 4-25 long
