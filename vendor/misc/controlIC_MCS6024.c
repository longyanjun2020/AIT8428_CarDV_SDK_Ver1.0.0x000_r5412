...
// lyj 20181026
static MMP_I2CM_ATTR gI2cmAttribute_MCS6024 = {MMP_I2CM_GPIO, MFS_I2C_SLAVE_ADDR, 8, 8, 0x80, MMP_FALSE, MMP_FALSE, MMP_FALSE, MMP_FALSE, 0, 0, 0, 50000/*SW support max 200KHZ*/, MMP_TRUE, /*MMP_GPIO36*/MMP_GPIO36, MMP_GPIO37, MMP_FALSE, MMP_FALSE};
#endif
#if (HARDWARE_PLATFORM == SEC_PLATFORM_PV2)
// lyj 20181026
static MMP_I2CM_ATTR gI2cmAttribute_MCS6024 = {MMP_I2CM_GPIO, MFS_I2C_SLAVE_ADDR, 8, 8, 0x80, MMP_FALSE, MMP_FALSE, MMP_FALSE, MMP_FALSE, 0, 0, 0, 50000/*SW support max 200KHZ*/, MMP_TRUE, /*MMP_GPIO38*/MMP_GPIO38, MMP_GPIO39, MMP_FALSE, MMP_FALSE};
#endif
#else
#if ((HARDWARE_PLATFORM == AIT_PLATFORM_PV1)||(HARDWARE_PLATFORM == SEC_PLATFORM_PV1))
static MMP_I2CM_ATTR gI2cmAttribute_MCS6024; //To be implement;
...
{
	MMPF_OS_PutMessage(HighTask_QId, (void *)(&MCS6024_GetPosition));
}
