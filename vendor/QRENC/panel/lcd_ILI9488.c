...
void RTNA_LCD_InitMainLCD(void)
{
	...
	#else
		m_PanelAttr.usHBPorch     = 60;          // Unit:pixel, Ragne:0~1023  50
	    m_PanelAttr.usHBlanking   = 60;        // Unit:pixel, Range:0~1023
	    m_PanelAttr.usHSyncW      = 3;           // Unit:pixel, Range:0~255
	    m_PanelAttr.usVBPorch     = 25;          // Unit:line,  Range:0~1023
	    m_PanelAttr.usVBlanking   = 35;        // Unit:line,  Range:0~1023
	    m_PanelAttr.usVSyncW      = 10;           // Unit:line,  Range:0~255
