...
#if 0
#if 1
static MMP_I2CM_ATTR gI2cmAttribute_FM7703 = {
	MMP_I2CM1, 
	FM_I2C_SLAVE_ADDR>>1, 
	8, 
	8, 
...
static void fm7703_readreg(void)
{
	MMP_UBYTE  i = 0;
	MMP_USHORT data[6] = {0};

	 //MMPF_I2cm_StartSemProtect(&gI2cmAttribute_FM7703);	
	MMPF_I2cm_WriteReg(&gI2cmAttribute_FM7703,0x00,0x12);
	// MMPF_I2cm_EndSemProtect(&gI2cmAttribute_FM7703);
	 
	//AHC_OS_SleepMs(1);
	//MMPF_I2cm_ReadReg(&gI2cmAttribute_FM7703, 0x45,  (MMP_USHORT*)&data);
	//MMPF_I2cm_ReadBurstData(&gI2cmAttribute_FM7703,0x00,data,6);
...
void fm7703_init(void)
{
      ...
      //MMPF_I2cm_Initialize(&gI2cmAttribute_FM7703);
	...
	//MMPS_PIO_EnableOutputMode(FM_PATH_SELECT_GPIO, MMP_FALSE);
