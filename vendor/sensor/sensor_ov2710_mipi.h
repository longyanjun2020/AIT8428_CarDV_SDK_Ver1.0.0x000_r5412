...
#ifndef	_SENSOR_OV2710_MIPI_H_
#define	_SENSOR_OV2710_MIPI_H_
...
#ifndef SENSOR_IF
#define SENSOR_IF 				(SENSOR_IF_MIPI_1_LANE) // OV2710 can support digital video port (DVP) parallel output interface and 1-lane MIPI interface (up to 800Mbps)
#endif
