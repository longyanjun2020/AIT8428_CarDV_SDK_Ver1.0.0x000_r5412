...
#ifndef	_SENSOR_AR2735_H_
#define	_SENSOR_AR2735_H_
...
#define SENSOR_IF 					(SENSOR_IF_MIPI_2_LANE) // DaulCam Only support Max 30FPS.

#if (SENSOR_IF == SENSOR_IF_PARALLEL)
#define PARALLEL_SENSOR_CROP_2M		(1)
#else
#define PARALLEL_SENSOR_CROP_2M		(0)
#endif

#define RES_IDX_1920x1080_30FPS     (0)
#define RES_IDX_1280x720_60FPS		(1)
...
#define SENSOR_DRIVER_MODE_HD_50P_RESOLUTION 		(RES_IDX_1280x720_60FPS) 			        // 1280*720  60P
...
#define SENSOR_DRIVER_MODE_1600x900_30P_RESOLUTION 	(SENSOR_DRIVER_MODE_NOT_SUUPORT) 	        // 1920*1080 30P
