...
#ifndef _SENSOR_AP1302_H_
#define _SENSOR_AP1302_H_
...
#ifndef SENSOR_PROI
#define SENSOR_PROI                 (SCD_SENSOR) //(PRM_SENSOR)//(SCD_SENSOR)
#endif

#ifndef SENSOR_I2C_ADDR_AP1302
#define SENSOR_I2C_ADDR_AP1302      (0x78 >> 1) // The device slave address are 0x60 for write and 0x61 for read
#endif

#define RES_IDX_YUV_1920x1080_30P   (0) // mode 0, 1920*1080@30fps
...
// Index 15
#define SENSOR_DRIVER_MODE_FULL_HD_30P_RESOLUTION   (RES_IDX_YUV_1920x1080_30P)              // 1920*1080 30P
...
// For Camera Preview
#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_16TO9_RESOLUTION (RES_IDX_YUV_1920x1080_30P)
#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_4TO3_RESOLUTION  (RES_IDX_YUV_1920x1080_30P)
...
#define SENSOR_DRIVER_MODE_DFT_RESOLUTION           (RES_IDX_YUV_1920x1080_30P)  

#endif // #if (SENSOR_PROI == PRM_SENSOR)

#endif // _SENSOR_AP1302_H_
