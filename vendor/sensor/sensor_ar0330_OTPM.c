...
typedef enum {
	VERSION_AR0330CS_UNKNOWN,
	VERSION_AR0330CS_V1,
    VERSION_AR0330CS_V2,
    VERSION_AR0330CS_V3,
    VERSION_AR0330CS_V4,
    VERSION_AR0330CS_V5,
    VERSION_AR0330CS_MAX
} VERSION_AR0330CS;
//==============================================================================
//
//                              GLOBAL VARIABLE
...
// IQ Data
#define ISP_IQ_DATA_NAME "isp_8428_iq_data_v2_AR0330_MP.xls.ciq.txt"
...
static void SNR_Cust_InitConfig(void)
{
	...
	if(1/*(MenuSettingConfig()->uiMOVSize == MOVIE_SIZE_720_60P)&&(uiGetCurrentState()==UI_VIDEO_STATE)*/)
	{
	    SensorCustFunc.OprTable->usInitSize                             = (sizeof(SNR_AR0330_MIPI_2_LANE_Reg_Init_720P60)/sizeof(SNR_AR0330_MIPI_2_LANE_Reg_Init_720P60[0]))/2;
	    SensorCustFunc.OprTable->uspInitTable                           = &SNR_AR0330_MIPI_2_LANE_Reg_Init_720P60[0];
	...
	SensorCustFunc.OprTable->usInitSize 							= (sizeof(SNR_AR0330_PARALLEL_Reg_Init_V5_Customer)/sizeof(SNR_AR0330_PARALLEL_Reg_Init_V5_Customer[0]))/2;
	SensorCustFunc.OprTable->uspInitTable 							= &SNR_AR0330_PARALLEL_Reg_Init_V5_Customer[0];
...
void SNR_Cust_CheckVersion(MMP_UBYTE ubSnrSel, MMP_ULONG *pulVersion)
{
    ...
    //SensorCustFunc.OprTable->usInitSize   = (sizeof(SNR_AR0330_MIPI_2_LANE_Reg_Init_Customer)/sizeof(SNR_AR0330_MIPI_2_LANE_Reg_Init_Customer[0]))/2;
    //SensorCustFunc.OprTable->uspInitTable = &SNR_AR0330_MIPI_2_LANE_Reg_Init_Customer[0];
	if((MenuSettingConfig()->uiMOVSize == MOVIE_SIZE_720_60P)&&(uiGetCurrentState()==UI_VIDEO_STATE))
	{
	    SensorCustFunc.OprTable->usInitSize                             = (sizeof(SNR_AR0330_MIPI_2_LANE_Reg_Init_720P60)/sizeof(SNR_AR0330_MIPI_2_LANE_Reg_Init_720P60[0]))/2;
	    SensorCustFunc.OprTable->uspInitTable                           = &SNR_AR0330_MIPI_2_LANE_Reg_Init_720P60[0];
	...
	{
	case 1:
    	SensorCustFunc.OprTable->usInitSize   = (sizeof(SNR_AR0330_PARALLEL_Reg_Init_V1_Customer)/sizeof(SNR_AR0330_PARALLEL_Reg_Init_V1_Customer[0]))/2;
    	SensorCustFunc.OprTable->uspInitTable = &SNR_AR0330_PARALLEL_Reg_Init_V1_Customer[0];
    	break;
	case 2:
    	SensorCustFunc.OprTable->usInitSize   = (sizeof(SNR_AR0330_PARALLEL_Reg_Init_V2_Customer)/sizeof(SNR_AR0330_PARALLEL_Reg_Init_V2_Customer[0]))/2;
    	SensorCustFunc.OprTable->uspInitTable = &SNR_AR0330_PARALLEL_Reg_Init_V2_Customer[0];
    	break;
    case 3:
    	SensorCustFunc.OprTable->usInitSize   = (sizeof(SNR_AR0330_PARALLEL_Reg_Init_V3_Customer)/sizeof(SNR_AR0330_PARALLEL_Reg_Init_V3_Customer[0]))/2;
    	SensorCustFunc.OprTable->uspInitTable = &SNR_AR0330_PARALLEL_Reg_Init_V3_Customer[0];
    	break;
	case 4:
    	SensorCustFunc.OprTable->usInitSize   = (sizeof(SNR_AR0330_PARALLEL_Reg_Init_V4_Customer)/sizeof(SNR_AR0330_PARALLEL_Reg_Init_V4_Customer[0]))/2;
    	SensorCustFunc.OprTable->uspInitTable = &SNR_AR0330_PARALLEL_Reg_Init_V4_Customer[0];
    	break;
	case 5:
    	SensorCustFunc.OprTable->usInitSize   = (sizeof(SNR_AR0330_PARALLEL_Reg_Init_V5_Customer)/sizeof(SNR_AR0330_PARALLEL_Reg_Init_V5_Customer[0]))/2;
    	SensorCustFunc.OprTable->uspInitTable = &SNR_AR0330_PARALLEL_Reg_Init_V5_Customer[0];
