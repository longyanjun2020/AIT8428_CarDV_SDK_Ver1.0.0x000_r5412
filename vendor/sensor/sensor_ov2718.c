...
// 	Mode0   Mode1   
    ...
    {1125,	1125},	// usVsyncLine (VTS: Reg0x380E-F)
    {1,		1},    	// ubWBinningN
    {1,		1},    	// ubWBinningM
    {1,		1},    	// ubHBinningN
    {1,		1},     // ubHBinningM
 ...
 */
#if defined (SNR_OV2718_SID_PIN) && (SNR_OV2718_SID_PIN == 1) // defined in Config_xxx.h
...
{	
	...
	//extra setting from demo code
	//0x315a, 0x03, //1.41x digital H gain 
	//0x315b, 0x16, //0x6A
	//0x315c, 0x04, //2.52x digital L gain   0x02
	//0x315d, 0x59
...
static void SNR_Cust_InitConfig(void)
{
	...
	RTNA_DBG_Str0(FG_PURPLE("SNR_Cust_InitConfig OV2718 Parallel\r\n"));
#elif (SENSOR_IF == SENSOR_IF_MIPI_2_LANE)
    RTNA_DBG_Str0(FG_PURPLE("SNR_Cust_InitConfig OV2718 MIPI 2-lane\r\n"));
#elif (SENSOR_IF == SENSOR_IF_MIPI_4_LANE)
	RTNA_DBG_Str0(FG_PURPLE("SNR_Cust_InitConfig OV2718 MIPI 4-lane\r\n"));
#endif
