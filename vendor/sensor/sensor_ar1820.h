...
#ifndef	_SENSOR_AR1820_H_
#define	_SENSOR_AR1820_H__
...
#define OPTIMIZE_1080_30P 			(1)  // For Mode15

#define RES_IDX_2568x1096_30P   	(0)  // Video Record 1080(1920x1080)@30P 
#define RES_IDX_2568x1096_50P   	(1)  // Video Record 1080(1920x1080)@50P
#define RES_IDX_2568x1096_60P   	(2)  // Video Record 1080(1920x1080)@60P
#define RES_IDX_1288x728_100P   	(3)  // Video Record 720(1280x720)@100P
#define RES_IDX_1288x728_120P   	(4)  // Video Record 720(1280x720)@120P
#define RES_IDX_2728x2010_30P   	(5)  // Video Record 2.7K(2704x1524)@30P
#define RES_IDX_3848x2168_15P   	(6)  // Video Record 4K(3840x2160)@15P

#define RES_IDX_3688x2776_15P   	(7)  // Photo 8M(3264x2448)@15P
#define RES_IDX_3688x2088_15P   	(8)  // Photo 6M-Wide(3264x1836)@15P --> (3264x1840)@15P
#define RES_IDX_2824x2120_10P   	(9)  // Photo 6M(2816x2112)@15P

#define RES_IDX_1848x1384_30P   	(10) // Preview 1280x960@30P
#define RES_IDX_1848x1048_30P   	(11) // Preview 1280x720@30P

#define RES_IDX_3848x2168_30P   	(12) // Video Record 2.7K(2704x1524)@30P  (MP)
#define RES_IDX_3848x1096_60P   	(13) // Video Record 1080(1920x1080)@60P  (MP)
#define RES_IDX_3848x1096_50P   	(14) // Video Record 1080(1920x1080)@50P  (MP)

#if (OPTIMIZE_1080_30P)
#define RES_IDX_3848x2168_30P_1080	(15) // Video Record 1080(1920x1080)@30P  (MP)
#else
#define RES_IDX_3848x1096_30P   	(15) // Video Record 1080(1920x1080)@30P  (MP)
#endif

#define RES_IDX_1928x1096_120P  	(16) // Video Record 720(1280x720)@120P   (MP)
#define RES_IDX_1928x1096_100P  	(17) // Video Record 720(1280x720)@100P   (MP)
#define RES_IDX_1928x1096_60P   	(18) // Video Record 720(1280x720)@60P    (MP)
#define RES_IDX_3688x1384_30P   	(19) // Photo 4:3(8M or 6M) preview @30P  (MP)
#define RES_IDX_3848x2168_30P_DSC 	(20) // Photo 16:9(6M wide) preview @30P(MP)
#define RES_IDX_3848x1096_25P   	(21) // Video Record 1080(1920x1080)@25P  (MP)
#define RES_IDX_1928x1096_50P   	(22) // Video Record 720(1280x720)@50P    (MP)
#define RES_IDX_1928x1096_30P  	 	(23) // Video Record 720(1280x720)@30P    (MP)
#define RES_IDX_1928x1096_25P   	(24) // Video Record 720(1280x720)@25P    (MP)
#define RES_IDX_3848x2168_12d5P 	(25) // Video Record 4K(3840x2160)@12.5P  //Reference RES_IDX_3848x2168_15P   (6)
#define RES_IDX_3848x2168_25P   	(26) // Video Record 2.7K(2704x1524)@25P  //Reference RES_IDX_3848x2168_30P   (12)

#define MAX_SENSOR_GAIN    	 		(8)
#define SNR_REG_DELAY   			(0xFFFF)
#define DELAY_TIME          		(300)

//Mode   Out         FOV          X-down  Y-down
//0      2568x1096   3840x2160    O       O
//1      2568x1096   3840x2160    O       O
//2      2568x1096   3840x2160    O       O
//3      1288x728    3840x2160    O       O
//4      1288x728    3840x2160    O       O
//5      2728x2010   3570x2002    O       X
//6      3848x2168   3840x2160    X       X
//7      3688x2776   3680x2764    X       X
//8      3688x2088   3680x2080    X       X
//9      2824x2120   3264x2448    O       O
//10     1848x1384   3680x2752    O       O
//11     1928x2056   3616x2056    O       X
//12     3848x2168   3840x2160    X       X
//13     3848x1096   3840x2160    X       O
//14     3848x1096   3840x2160    X       O
//15     3848x1096   3840x2160    X       O
//16     1928x1096   3840x2160    O       O
//17     1928x1096   3840x2160    O       O
//18     1928x1096   3840x2160    O       O
//19     3688x1384   3680x2752    X       O
//20     3848x2168   3840x2160    X       X
//21     3848x1096   3840x2160    X       O
//22     1928x1096   3840x2160    O       O
//23     1928x1096   3840x2160    O       O
//24     1928x1096   3840x2160    O       O

#define ENABLE_CUSTOMIZED_AE		(1)
...
#define SENSOR_DRIVER_MODE_HD_30P_RESOLUTION            (RES_IDX_1928x1096_30P)                   	// 1280*720  30P
...
#define SENSOR_DRIVER_MODE_1600x900_30P_RESOLUTION  	(RES_IDX_3848x2168_30P_1080)				// 1600*900 30P
...
// Index 15
#define SENSOR_DRIVER_MODE_FULL_HD_30P_RESOLUTION       (RES_IDX_3848x2168_30P_1080)         		// 1920*1080 30P
...
// For Camera Preview
#define SENSOR_DRIVER_MODE_BEST_CAMERA_PREVIEW_RESOLUTION   	(RES_IDX_1848x1384_30P)

#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_16TO9_RESOLUTION (RES_IDX_1848x1048_30P)
#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_4TO3_RESOLUTION  (RES_IDX_1848x1384_30P)

#define SENSOR_DRIVER_MODE_FULL_HD_30P_RESOLUTION_HDR   (SENSOR_DRIVER_MODE_NOT_SUUPORT)

#endif //_SENSOR_AR1820_H_
