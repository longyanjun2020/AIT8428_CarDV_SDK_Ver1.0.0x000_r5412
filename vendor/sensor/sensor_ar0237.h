...
#ifndef	_SENSOR_AR0330_H_
#define	_SENSOR_AR0330_H_
...
//#define SENSOR_IF 					(SENSOR_IF_PARALLEL) // DaulCam Only support Max 30FPS.

#if (SENSOR_IF == SENSOR_IF_PARALLEL)
#define PARALLEL_SENSOR_CROP_2M		(0)
#else
#define PARALLEL_SENSOR_CROP_2M		(0)
#endif

#define RES_IDX_1920x1080_30FPS   	(0)
#define RES_IDX_1920x1080_25FPS		(1)
#define RES_IDX_1920x1080_60FPS    	(2)

#define RES_IDX_1280x720_30FPS		(3)


//#define REMOVE_SENSOR_MANUAL_OTP_SETTINGS 	(0)
//==============================================================================
//
...
// Index 0
#define SENSOR_DRIVER_MODE_VGA_30P_RESOLUTION 		(RES_IDX_1920x1080_30FPS)			// 640*360  30P   
...
// Index 5
#define SENSOR_DRIVER_MODE_HD_24P_RESOLUTION        (RES_IDX_1920x1080_25FPS)            // 1280*720  24P
#define SENSOR_DRIVER_MODE_HD_30P_RESOLUTION 		(RES_IDX_1920x1080_30FPS) 			// 1280*720  30P
...
#define SENSOR_DRIVER_MODE_FULL_HD_25P_RESOLUTION 	(RES_IDX_1920x1080_25FPS) 	    	        // 1920*1080 25P
#define SENSOR_DRIVER_MODE_FULL_HD_30P_RESOLUTION 	(RES_IDX_1920x1080_30FPS) 					// 1920*1080 30P
#define SENSOR_DRIVER_MODE_1600x900_30P_RESOLUTION 	(SENSOR_DRIVER_MODE_NOT_SUUPORT) 	    	// 1920*1080 15P

// Index 15
#define SENSOR_DRIVER_MODE_FULL_HD_50P_RESOLUTION 	(SENSOR_DRIVER_MODE_NOT_SUUPORT) 			// 1920*1080 50P
#define SENSOR_DRIVER_MODE_FULL_HD_60P_RESOLUTION 	(RES_IDX_1920x1080_60FPS) 			        // 1920*1080 60P
...
#define SENSOR_DRIVER_MODE_4K2K_24P_RESOLUTION 		(SENSOR_DRIVER_MODE_NOT_SUUPORT) 			// 3840*2160 15P
...
// For Camera Preview
#define SENSOR_DRIVER_MODE_BEST_CAMERA_PREVIEW_RESOLUTION       (RES_IDX_1920x1080_30FPS)

#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_16TO9_RESOLUTION (RES_IDX_1920x1080_30FPS)
#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_4TO3_RESOLUTION  (RES_IDX_1920x1080_30FPS)

#define SENSOR_DRIVER_MODE_FULL_HD_30P_RESOLUTION_HDR           (SENSOR_DRIVER_MODE_NOT_SUUPORT)

#endif //_SENSOR_AR0330_H_
