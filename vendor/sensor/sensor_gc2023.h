...
#ifndef	_SENSOR_GC2023_H_
#define	_SENSOR_GC2023_H_
...
#ifndef SENSOR_IF
#define SENSOR_IF 				(SENSOR_IF_MIPI_1_LANE) // GC2023 can support digital video port (DVP) parallel output interface and 1-lane MIPI interface (up to 800Mbps)
#endif
...
#define RES_IDX_1280x720_30P 	(1) 	// mode 2, 1280 *  720 30P, Video  (16:9), cropped from FHD30P, TBC??
//#define RES_IDX_1280x720_60P 	(3) 	// mode 3, 1280 *  720 60P, Video  (16:9)
#define RES_IDX_1440x1080_30P 	(2) 	// mode 4, 1440 * 1080 30P, Camera ( 4:3)
#define RES_IDX_640x480_30P 	(3) 	// mode 6,  640 *  480 30P, Camera ( 4:3), 1D5M30P (cropped from FHD30P) scaling down to VGA30P
...
// Index 0
#define SENSOR_DRIVER_MODE_VGA_30P_RESOLUTION 		(RES_IDX_640x480_30P) 	        	// 640*360 30P
...
#define SENSOR_DRIVER_MODE_1600x900_30P_RESOLUTION	(SENSOR_DRIVER_MODE_NOT_SUUPORT)
