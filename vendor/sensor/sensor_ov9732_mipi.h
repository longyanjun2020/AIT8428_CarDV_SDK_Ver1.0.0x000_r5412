...
#ifndef	_SENSOR_OV9712_MIPI_H_
#define	_SENSOR_OV9712_MIPI_H_
...
#define RES_IDX_640x480_30P 	(1) 	// mode 6,  640 *  480 30P, Camera ( 4:3), 1D5M30P (cropped from FHD30P) scaling down to VGA30P
