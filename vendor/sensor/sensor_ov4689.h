...
#endif
#define RES_IDX_2560x1440_60P       (1)     // mode 1,  2560*1440 60P
...
#define RES_IDX_1520x1520_30P       (14)    // mode 14, 1520*1520 30P
#define RES_IDX_2688x1512_24P       (15)    // mode 15, 2688*1520 24P       // Video (16:9)
...
// Index 0
#define SENSOR_DRIVER_MODE_VGA_30P_RESOLUTION       (RES_IDX_2688x1520_30P)             // 640*360 30P
...
// Index 10
#define SENSOR_DRIVER_MODE_HD_120P_RESOLUTION       (RES_IDX_1280x720_120P)    // 1280*720 120P
#define SENSOR_DRIVER_MODE_1600x900_30P_RESOLUTION  (RES_IDX_2688x1520_30P)             // 1600*900 30P
...
#define SENSOR_DRIVER_MODE_FULL_HD_60P_RESOLUTION   (RES_IDX_2560x1440_60P)             // 1920*1080 60P
...
#define SENSOR_DRIVER_MODE_1440_30P_RESOLUTION  	(RES_IDX_2688x1520_30P)             // 2560*1440 30P
...
// Index 30
#define SENSOR_DRIVER_MODE_4TO3_3M_30P_RESOLUTION   (RES_IDX_2016x1512_30P)             // 2016*1512 30P
#define SENSOR_DRIVER_MODE_4TO3_5M_15P_RESOLUTION   (SENSOR_DRIVER_MODE_NOT_SUUPORT)    // 2560*1920 15P
#define SENSOR_DRIVER_MODE_4TO3_5M_30P_RESOLUTION   (RES_IDX_2016x1512_30P)             // 2560*1920 30P
#define SENSOR_DRIVER_MODE_4TO3_8M_15P_RESOLUTION   (SENSOR_DRIVER_MODE_NOT_SUUPORT)    // 3264*2448 15P
#define SENSOR_DRIVER_MODE_4TO3_8M_30P_RESOLUTION   (RES_IDX_2016x1512_30P)             // 3264*2448 30P

// Index 35
#define SENSOR_DRIVER_MODE_4TO3_10M_15P_RESOLUTION  (SENSOR_DRIVER_MODE_NOT_SUUPORT)    // 3648*2736 15P
#define SENSOR_DRIVER_MODE_4TO3_10M_30P_RESOLUTION  (RES_IDX_2016x1512_30P)             // 3648*2736 30P
#define SENSOR_DRIVER_MODE_4TO3_12M_15P_RESOLUTION  (SENSOR_DRIVER_MODE_NOT_SUUPORT)    // 4032*3024 15P
#define SENSOR_DRIVER_MODE_4TO3_12M_30P_RESOLUTION  (RES_IDX_2016x1512_30P)             // 4032*3024 30P
#define SENSOR_DRIVER_MODE_4TO3_14M_15P_RESOLUTION  (SENSOR_DRIVER_MODE_NOT_SUUPORT)    // 4352*3264 15P

// Index 40
#define SENSOR_DRIVER_MODE_4TO3_14M_30P_RESOLUTION  (RES_IDX_2016x1512_30P)             // 4352*3264 30P
#define SENSOR_DRIVER_MODE_4K2K_24P_RESOLUTION      (RES_IDX_2688x1512_24P)             // 3200*1800 30P (Scaler up)
