...
// Mode0 	Mode1 	Mode2 	Mode3 	Mode4 	Mode5 	Mode6 	Mode7 	Mode8 	Mode9 	Mode10  Mode11  Mode12
	...
	{1141,   1141,   1141,   1141,   1141,   1141,   1141,    750,   1141,   1141,   1141,   1141,   1141}, // usVsyncLine
...
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160822.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160913.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160923v2.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160924v1.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160924v2.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160925.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160925v2.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160926.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160926v2.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160927.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160927v2.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160927v3.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160927v4.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20160927v5.xls.ciq.txt"

#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20161018.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20161019v1.xls.ciq.txt"
//#include "isp_8428_iq_data_v3_IMX323_ezmode_MI_20161019v2.xls.ciq.txt"
...
// IQ Data
//#define ISP_IQ_DATA_NAME "isp_8428_iq_data_v2_IMX322.xls.ciq.txt"
...
static void SNR_Cust_InitConfig(void)
{
	...
	SensorCustFunc.VifSetting->clockAttr.ubClkFreqDiv 				= ulSensorClkSrc / ulSensorMCLK; // (297MHz / 37.125MHz)
...
///*0704less*/				,60,		60,		 	70,	        82,		    102,	 	126,	 	150,	 	173,	    194,	    212,	230,	242,	242,	242,	242,	242,	242,   242

///*Tar1210*/               ,72,         76,        84,			96,         110,        124,        148,        170,      	190,		202,    220,  	237,  	256,  	256,  	256,  	256,  256,   256
///*Tar*/					,65,		70,			80,			90,			100,		115,		135,		155,		175,		195,	210,	225,	240,	245,	250,	256,	256,	256
///*Tar0923v2*/				,60,		65,			73,			80,			90,			110,		135,		155,		175,		195,	210,	225,	240,	245,	250,	256,	256,	256
///*Tar0924v1 night*/		,53,		57,			64,			72,			90,			110,		135,		155,		175,		195,	210,	220,	230,	235,	240,	245,	250,	256
///*Tar0925*/				,53,		57,			64,			72,			85,			100,		110,		122,		135,		145,	155,	170,	185,	215,	260,	310,	330,	350

///*0926*/					,60,		60,			70,			82,			100,		110,		120,		130,		145,		157,	170,	185,	200,	215,	260,	310,	330,	350
///*Tar0924v2, 0926v2*/		,53,		57,			64,			72,			85,			100,		115,		130,		145,		157,	170,	185,	200,	215,	260,	310,	330,	350

///*SZ, 0925v2, 0927*/		,48,		52,			59,			66,			79,			96,			115,		130,		145,		157,	170,	185,	200,	215,	260,	310,	330,	350
///*0927v3,v4,v5*/			,48,		52,			59,			66,			79,			105,		135,		165,		180,		190,	200,	210,	220,	230,	260,	300,	330,	350

///*1018*/					,46,		50,			56,			63,			75,			102,		135,		165,		180,		190,	200,	210,	220,	230,	260,	300,	330,	350
/*1019v1,v2*/				,46,		50,			56,			63,			75,			102,		135,		165,		180,		190,	205,	220,	240,	255,	275,	300,	330,	350
...
void SNR_Cust_DoAE_FrmSt(MMP_UBYTE ubSnrSel, MMP_ULONG ulFrameCnt)
{
	...
	if ((ulFrameCnt % m_AeTime.ubPeriod) == 1)
		ISP_IF_IQ_SetAEGain(dgain, DGAIN_1X);
...
static void SNR_Cust_DoAWB_FrmSt(MMP_UBYTE ubSnrSel, MMP_ULONG ulFrameCnt)
{
	...
	*(MMP_UBYTE*) 0x80007050 = ISP_IF_AWB_GetDbgData(8);
	*(MMP_UBYTE*) 0x80007052 = ISP_IF_AWB_GetDbgData(9);
}
