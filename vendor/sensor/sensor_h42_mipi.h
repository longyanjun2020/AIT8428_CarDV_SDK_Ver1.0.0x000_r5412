...
#ifndef	_SENSOR_H42_H_
#define	_SENSOR_H42_H_
...
//#define SENSOR_IF 				(SENSOR_IF_MIPI_1_LANE) // H42 can support digital video port (DVP) parallel output interface and 1-lane MIPI interface (up to 800Mbps)

#ifndef PRM_SENSOR_VIF_ID
#define PRM_SENSOR_VIF_ID 		(MMPF_VIF_MDL_ID0)
#endif

#define RES_IDX_1280x720_30P 	(0) 	// mode 2, 1280 *  720 30P, Video  (16:9), cropped from FHD30P, TBC??
#define RES_IDX_1280x720_60P 	(1) 	// mode 3, 1280 *  720 60P, Video  (16:9)
#define RES_IDX_960x720_30P 	(2) 	// mode 6,  960 *  720 30P, Camera ( 4:3), 1D5M30P (cropped from FHD30P) scaling down to VGA30P
...
#define SENSOR_DRIVER_MODE_4K2K_15P_RESOLUTION 		(RES_IDX_960x720_30P) 				// 3840*2160 15P

// Index 25
#define SENSOR_DRIVER_MODE_4K2K_30P_RESOLUTION 		(RES_IDX_960x720_30P) 				// 3840*2160 30P
#define SENSOR_DRIVER_MODE_4TO3_VGA_30P_RESOLUTION 	(RES_IDX_960x720_30P) 		    	// 640*480   30P
#define SENSOR_DRIVER_MODE_4TO3_1D2M_30P_RESOLUTION (RES_IDX_960x720_30P) 	        	// 1280*960  30P
#define SENSOR_DRIVER_MODE_4TO3_1D5M_30P_RESOLUTION (RES_IDX_960x720_30P) 	        	// 1440*1080 30P
#define SENSOR_DRIVER_MODE_4TO3_3M_15P_RESOLUTION 	(RES_IDX_960x720_30P) 				// 2048*1536 15P

// Index 30
#define SENSOR_DRIVER_MODE_4TO3_3M_30P_RESOLUTION 	(RES_IDX_960x720_30P) 	        	// 2048*1536 30P
#define SENSOR_DRIVER_MODE_4TO3_5M_15P_RESOLUTION 	(RES_IDX_960x720_30P) 				// 2560*1920 15P
#define SENSOR_DRIVER_MODE_4TO3_5M_30P_RESOLUTION 	(RES_IDX_960x720_30P) 	        	// 2560*1920 30P
#define SENSOR_DRIVER_MODE_4TO3_8M_15P_RESOLUTION 	(RES_IDX_960x720_30P) 				// 3264*2448 15P
#define SENSOR_DRIVER_MODE_4TO3_8M_30P_RESOLUTION 	(RES_IDX_960x720_30P) 	        	// 3264*2448 30P

// Index 35
#define SENSOR_DRIVER_MODE_4TO3_10M_15P_RESOLUTION 	(RES_IDX_960x720_30P) 				// 3648*2736 15P
#define SENSOR_DRIVER_MODE_4TO3_10M_30P_RESOLUTION 	(RES_IDX_960x720_30P) 	        	// 3648*2736 30P
#define SENSOR_DRIVER_MODE_4TO3_12M_15P_RESOLUTION 	(RES_IDX_960x720_30P) 				// 4032*3024 15P
#define SENSOR_DRIVER_MODE_4TO3_12M_30P_RESOLUTION 	(RES_IDX_960x720_30P) 	        	// 4032*3024 30P
#define SENSOR_DRIVER_MODE_4TO3_14M_15P_RESOLUTION 	(RES_IDX_960x720_30P) 				// 4352*3264 15P

// Index 40
#define SENSOR_DRIVER_MODE_4TO3_14M_30P_RESOLUTION 	(RES_IDX_960x720_30P) 	        	// 4352*3264 30P
#define SENSOR_DRIVER_MODE_4K2K_24P_RESOLUTION      (SENSOR_DRIVER_MODE_NOT_SUUPORT)

// For Camera Preview
#if (LCD_MODEL_RATIO_X == 16) && (LCD_MODEL_RATIO_Y == 9)
#define SENSOR_DRIVER_MODE_BEST_CAMERA_PREVIEW_RESOLUTION       (RES_IDX_1280x720_30P)
#else
#define SENSOR_DRIVER_MODE_BEST_CAMERA_PREVIEW_RESOLUTION       (RES_IDX_960x720_30P)
#endif

#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_16TO9_RESOLUTION (RES_IDX_1280x720_30P)
#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_4TO3_RESOLUTION  (RES_IDX_960x720_30P)

#define SENSOR_DRIVER_MODE_FULL_HD_30P_RESOLUTION_HDR   (SENSOR_DRIVER_MODE_NOT_SUUPORT)
#define SENSOR_DRIVER_MODE_PCCAM_DEFAULT_RESOLUTION     (SENSOR_DRIVER_MODE_HD_30P_RESOLUTION)
#endif //_SENSOR_H42_H_
