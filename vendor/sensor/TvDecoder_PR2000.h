...
#ifndef _TV_DEC_RN6750_H_
#define _TV_DEC_RN6750_H_
...
#ifndef TVDEC_SNR_IF
#define TVDEC_SNR_IF                (SENSOR_IF_MIPI_2_LANE)//(SENSOR_IF_MIPI_4_LANE)
#endif

#ifndef TVDEC_SNR_PROI
#define TVDEC_SNR_PROI              (PRM_SENSOR)
#endif
...
#define RES_IDX_HD_30FPS            (0) // HD 30fps
#define RES_IDX_HD_25FPS            (1) // HD 25fps 
...
#define SENSOR_DRIVER_MODE_HD_30P_RESOLUTION        (RES_IDX_HD_25FPS)    				// 1280*720 30P
...
#define SENSOR_DRIVER_MODE_4TO3_1D2M_30P_RESOLUTION (RES_IDX_HD_25FPS)    // 1280*960  30P
#define SENSOR_DRIVER_MODE_4TO3_1D5M_30P_RESOLUTION (RES_IDX_HD_25FPS)    // 1440*1080 30P
...
#define SENSOR_DRIVER_MODE_BEST_CAMERA_PREVIEW_RESOLUTION       (RES_IDX_HD_25FPS)
#else
#define SENSOR_DRIVER_MODE_BEST_CAMERA_PREVIEW_RESOLUTION       (RES_IDX_HD_25FPS)
#endif

#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_16TO9_RESOLUTION (RES_IDX_HD_25FPS)
#define SENSOR_DRIVER_MODE_BEST_CAMERA_CAPTURE_4TO3_RESOLUTION  (RES_IDX_HD_25FPS)

#define SENSOR_DRIVER_MODE_FULL_HD_30P_RESOLUTION_HDR           (SENSOR_DRIVER_MODE_NOT_SUUPORT)

#define SENSOR_DRIVER_MODE_PAL_25P_RESOLUTION       (SENSOR_DRIVER_MODE_NOT_SUUPORT)    
#define SENSOR_DRIVER_MODE_NTSC_30P_RESOLUTION      (SENSOR_DRIVER_MODE_NOT_SUUPORT)  

#else // #if (TVDEC_SNR_PROI == PRM_SENSOR)

#define SENSOR_DRIVER_MODE_AHDHD_30P_RESOLUTION          (RES_IDX_HD_30FPS)
#define SENSOR_DRIVER_MODE_AHDHD_25P_RESOLUTION          (RES_IDX_HD_25FPS)

#endif // #if (TVDEC_SNR_PROI == PRM_SENSOR)

#endif // _TV_DEC_RN6750_H_
