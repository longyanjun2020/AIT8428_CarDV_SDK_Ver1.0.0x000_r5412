...
#ifndef _SENSOR_BRV0500_H_
#define _SENSOR_BRV0500_H_
...
#define SENSOR_DRIVER_MODE_4K2K_24P_RESOLUTION      (SENSOR_DRIVER_MODE_NOT_SUUPORT)    // 3200*1800 30P (Scaler up)
