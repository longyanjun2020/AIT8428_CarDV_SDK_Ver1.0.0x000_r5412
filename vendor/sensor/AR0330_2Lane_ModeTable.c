...
#define AR0330_MIPI_2LANE_60FPS		(0)
#define AR0330_MIPI_2LANE_59_94FPS	(!AR0330_MIPI_2LANE_60FPS)
...
//  Mode0   Mode1   Mode2   Mode3
    ...
    {2312,  2312,   2311,   1156,   1288},	// usVifGrabW
    {1300,  1300,   1540,   652,    728},	// usVifGrabH
	#if (CHIP == MCR_V2)
    {1,     1,    1,      1,      1},	    // usVifGrabStX
    {1,     1,    1,      1,      1},	    // usVifGrabStY
    {8,     8,   263,    4,      8},     // usBayerDummyInX
    {4,     4,    4,      4,      8},     // usBayerDummyInY
...
#if AR0330_MIPI_2LANE_60FPS
    {1329,  1329,  1540,   672,    751},	// usVsyncLine
#else
    {1329,  1329,  1540,   672,    752},	// usVsyncLine
#endif
...
MMP_USHORT SNR_AR0330_MIPI_2_LANE_Reg_Init_720P60[] = 
{
    //0x31AE, 0x0202,
    0x301A, 0x0059,     // Disable streaming
    SENSOR_DELAY_REG, 200,
	0x301A, 0x0058,     // Drive Pins,Parallel Enable,SMIA Serializer Disable
    0x31AE, 0x202,      // Output 2-lane MIPI
	0x31AC,	0x0A0A,

    //MIPI TIMING
    0x31B0, 0x0032,         // FRAME PREAMBLE
    0x31B2, 0x0014,         // LINE PREAMBLE
    0x31B4, 0x3D45,     // MIPI TIMING 0
    0x31B6, 0x418E,     // MIPI TIMING 1
    0x31B8, 0x208A,     // MIPI TIMING 2
    0x31BA, 0x0207,     // MIPI TIMING 3
    0x31BC, 0x8006,     // MIPI TIMING 4
    0x31BE, 0x2003,     // MIPI CONFIG STATUS	
    ...
    //Configure for Serial Interface
    0x3064, 0x1082, 	// Disable Embedded Data
    0x301A, 0x0058,     // 
...
{
	0x3004,   514,		//0x0202,	// X_ADDR_START
	0x3008,   514+1287,	//0x0709,	// X_ADDR_END
	0x3002,   410,		//0x019A,	// Y_ADDR_START
	0x3006,   410+727,	//0x0471, 	// Y_ADDR_END
	0x30A2,   1,		//0x0001,     // X_ODD_INC
	0x30A6,   1,		//0x0001,     // Y_ODD_INC
	...
	0x300C,  1242, 		//0X04DA,     // LINE_LENGTH_PCK
#if AR0330_MIPI_2LANE_60FPS		
	0x300A,   751,		//0x02EF,     // FRAME_LENGTH_LINES
#else
	0x300A,   752,		//0x02F0,     // FRAME_LENGTH_LINES
#endif	
	0x3014,	0x0000,     // FINE_INTEGRATION_TIME
	0x3012, 0x0220,     // COARSE_INTEGRATION_TIME

#if AR0330_MIPI_2LANE_60FPS	
	0x3042, 591			//0x024f,     // EXTRA_DELAY
#else	
	0x3042, 283,		//0x011B,     // EXTRA_DELAY
#endif	
