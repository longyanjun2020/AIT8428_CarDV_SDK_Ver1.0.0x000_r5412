...
static void SNR_GM7150_Cust_DoAWB_FrmSt(MMP_UBYTE ubSnrSel, MMP_ULONG ulFrameCnt)
{
    // TBD
}
static void SNR_GM7150_Cust_DoAWB_FrmEnd(MMP_UBYTE ubSnrSel, MMP_ULONG ulFrameCnt)
{
    // TBD
}
...
static void SNR_GM7150_Cust_SetExposure(MMP_UBYTE ubSnrSel, MMP_ULONG ulGain, MMP_ULONG ulShutter, MMP_ULONG ulVsync)
{
    //TBD
...
static const MMP_UBYTE* SNR_GM7150_Cust_GetIqCompressData(MMP_UBYTE ubSnrSel)
{
    return NULL;
}
...
//------------------------------------------------------------------------------
static void SNR_GM7150_Cust_StreamEnable(MMP_UBYTE ubSnrSel, MMP_BOOL bEnable)
{
    // TBD
}
...
//  Description :
//------------------------------------------------------------------------------
void SNR_GM7150_Cust_CheckSnrTVSrcType(MMP_UBYTE ubSnrSel, MMP_SNR_TVDEC_SRC_TYPE *TVSrcType)
{
	MMP_USHORT usData;
...
MMPF_SENSOR_CUSTOMER SubSensorCustFunc = 
{
	...
	SNR_GM7150_Cust_InitConfig,
       SNR_GM7150_Cust_DoAE_FrmSt,
       SNR_GM7150_Cust_DoAE_FrmEnd,
       SNR_GM7150_Cust_DoAWB_FrmSt,
       SNR_GM7150_Cust_DoAWB_FrmEnd,
       SNR_GM7150_Cust_DoIQ,
       SNR_GM7150_Cust_SetGain,
       SNR_GM7150_Cust_SetShutter,
       SNR_GM7150_Cust_SetExposure,
       SNR_GM7150_Cust_SetFlip,
       SNR_GM7150_Cust_SetRotate,
       SNR_GM7150_Cust_CheckVersion,
       SNR_GM7150_Cust_GetIqCompressData,
       SNR_GM7150_Cust_StreamEnable,
