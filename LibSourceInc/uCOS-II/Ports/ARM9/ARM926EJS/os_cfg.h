...
#define OS_VIEW_MODULE            0    /* When 1, indicate that uC/OS-View is present                    */
                                       ...
                                       /* --------------------- TASK STACK SIZE ----------------------   */
#define OS_TASK_TMR_STK_SIZE    2048    /* Timer      task stack size (# of OS_STK wide entries)          */
...
//[jerry] #define OS_LOWEST_PRIO           63    /* Defines the lowest priority that can be assigned ...           */
                                       /* ... MUST NEVER be higher than 254!                             */

#define OS_MAX_EVENTS            250    /* Max. number of event control blocks in your application        */
#define OS_MAX_FLAGS             64    /* Max. number of Event Flag Groups    in your application        */
#define OS_MAX_MEM_PART           5    /* Max. number of memory partitions                               */
#define OS_MAX_QS                (4+12+4) /* Max. number of queue control blocks in your application        */
#define OS_MAX_TASKS             63    /* Max. number of tasks in your application, MUST be >= 2         */
//[jerry] #define OS_MAX_TASKS             20    /* Max. number of tasks in your application, MUST be >= 2         */
...
//[jerry]
#define OS_TASK_ARM_THUMB_EN      1     //[jerry] Support ARM task and THUMB task simulatenously.
                                        // OSTaskCreateExt(), OS_TASK_OPT_CPU_THUMB
#define OS_TICK_STEP_EN           1    /* Enable tick stepping feature for uC/OS-View                    */
#ifdef ARMUL                            //[jerry] Support software timer tick on ARMUL
...
#endif
//[jerry] #define OS_TICKS_PER_SEC        100    /* Set the number of ticks in one second                          */
...
#define OS_STACK_EYE_CATCH    ((OS_STK)0x16816888)
