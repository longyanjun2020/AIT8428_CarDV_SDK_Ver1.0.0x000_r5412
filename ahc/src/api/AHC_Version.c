...
#define FW_VERSION_MAJOR           	0x0002
#define FW_VERSION_MEDIUM          	0x0001
#define FW_VERSION_MINOR           	0x015A
...
#else
#define FW_VERSION_RELEASE_NAME   	"AIT8428_CarDV_SDK"
#endif
#define FW_STANDALONE_BASE    		1298
