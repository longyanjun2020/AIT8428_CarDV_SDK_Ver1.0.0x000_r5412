...
#define EVENT_INDEX_SHIFT_BIT_FUNCTION_SUB  (8)
...
#define EVENT_INDEX_OFFSET_FUNCTION_SUB     (1 << EVENT_INDEX_SHIFT_BIT_FUNCTION_SUB)
#define EVENT_INDEX_OFFSET_FUNCTION_MISC    (1 << EVENT_INDEX_SHIFT_BIT_FUNCTION_MISC)

#define MAX_EVENT_INDEX_FUNCTION_MAIN       (0x0D)
#define MAX_EVENT_INDEX_FUNCTION_SUB        (0x02)
#define MAX_EVENT_INDEX_FUNCTION_MISC       (0x80)

#define INDEX_TOUCH_OFFSET                  (EVENT_INDEX_OFFSET_FUNCTION_SUB)
