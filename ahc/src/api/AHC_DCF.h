...
#define DCF_MAX_FILE_NAME_SIZE		64//MAX_FILE_NAME_SIZE
...
/*
C003_P000:
    DCF_DB_TYPE_1ST_DB = 0,///< DCIM
    DCF_DB_TYPE_2ND_DB = 1,///< PARK
Spt:
    DCF_DB_TYPE_1ST_DB = 0,///< DCIM
    DCF_DB_TYPE_2ND_DB = 1,///< EVSW
    DCF_DB_TYPE_3RD_DB = 2,///< EVGS
    DCF_DB_TYPE_4TH_DB = 3,///< PICT
*/
    DCF_DB_TYPE_1ST_DB = 0,
    DCF_DB_TYPE_2ND_DB = 1,
    DCF_DB_TYPE_3RD_DB = 2,
    DCF_DB_TYPE_4TH_DB = 3,
    DCF_DB_TYPE_5TH_DB = 4,
