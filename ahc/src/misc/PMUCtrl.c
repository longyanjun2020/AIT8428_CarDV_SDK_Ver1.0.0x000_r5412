...
void PMUCtrl_Power_Off(void)
{
	...
	#if 0 //defined(ALL_FW) // lyj 20181029
    ...
    while (1) {
		...
		#if 0// defined(ALL_FW)//due to power down too slowly. // lyj 20181029
			if((AHC_IsDcCableConnect()!=bPoweroffAdapterStatus)&&(!bPoweroffAdapterStatus))//fast test
			{
