...
#define MENU_STILL_SIZE_8M_EN                   	(1)//(1)
...
#define MENU_MOVIE_SIZE_1080_60P_EN                 (0)     // Only for AIT8428
...
#define MENU_MOVIE_SIZE_1080P_30_HDR_EN             (0 & (BIND_SENSOR_OV4689 | BIND_SENSOR_OV2718_2A))  // 1 for HDR#define MENU_MOVIE_SIZE_1080_25P_EN                	(0)
...
#define MENU_MOVIE_CLIP_TIME_3MIN_EN				(1)
 #define MENU_MOVIE_CLIP_TIME_5MIN_EN				(0) // lyj 20190513
...
#define MENU_MOVIE_POWER_OFF_DELAY_0SEC_EN          (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_5SEC_EN          (1)
#define MENU_MOVIE_POWER_OFF_DELAY_10SEC_EN         (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_15SEC_EN         (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_30SEC_EN         (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_60SEC_EN         (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_1MIN_EN          (MENU_MOVIE_POWER_OFF_DELAY_60SEC_EN)
#define MENU_MOVIE_POWER_OFF_DELAY_2MIN_EN          (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_3MIN_EN          (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_5MIN_EN          (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_10MIN_EN         (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_15MIN_EN         (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_30MIN_EN         (1)// 0
#define MENU_MOVIE_POWER_OFF_DELAY_60MIN_EN         (1)// 0
...
#define MENU_MOVIE_VMD_REC_TIME_1MIN_EN          	(0)

#if defined(VIDEO_REC_TIMELAPSE_EN) && VIDEO_REC_TIMELAPSE_EN
    #if 0 //Mantis_1029756: TIMELAPSE for single cam only.
...
#if 0 //Mantis_1029756: SLOWMOTION for single cam only
#define	MENU_MOVIE_SLOWMOTION_MODE_EN               (1)
#else        
#define MENU_MOVIE_SLOWMOTION_MODE_EN        		(0)    
#endif 
#define	MENU_MOVIE_WNR_MODE_EN                      (0)

#define MENU_REARCAM_TYPE_EN							(1)
...
#define MENU_MOVIE_HDR_MODE_EN                      (!SNR_CLK_POWER_SAVING_SETTING & 1)//(!SNR_CLK_POWER_SAVING_SETTING & 0)
...
#define MENU_MANUAL_ISO_1200_EN                 	(1)
...
#define MENU_MANUAL_WB_FLUORESCENT2_EN          	(1)
#define MENU_MANUAL_WB_CLOUDY_EN                	(1)
#define MENU_MANUAL_WB_FLUORESCENT3_EN          	(1)
...
/* Playback */
#define MENU_PLAYBACK_PAGE_EN						(0)
...
#define MENU_GENERAL_LCD_ROTATE_EN					(1)
#define MENU_GENERAL_LCD_ROTATE_ON_EN				(1)
#define MENU_GENERAL_LCD_ROTATE_OFF_EN				(1)

#define MENU_GENERAL_REARCAM_MIRROR_EN				(1)
#define MENU_GENERAL_REARCAM_MIRROR_ON_EN			(1)
#define MENU_GENERAL_REARCAM_MIRROR_OFF_EN			(1)
...
#define MENU_GENERAL_LDWS_CALIBRATION_EN		    (ENABLE_ADAS_LDWS & 1)
#define MENU_GENERAL_FCWS_CALIBRATION_EN		    (MENU_GENERAL_LDWS_CALIBRATION_EN & 1)
#define MENU_RD_LDWS_CALIBRATION_EN 				(MENU_GENERAL_LDWS_CALIBRATION_EN & 0)
/////////////////////////////////////////////////////////////
...
#define OSD_SHOW_BATTERY_STATUS						(1)
