 ...
 * PCBA config file
 */
#ifndef _CONFIG_SDK_BD_V01_H_
#define _CONFIG_SDK_BD_V01_H_
...
#define LCD_GPIO_BACK_LIGHT             (MMP_GPIO5)    // AGPIO3 -->> LCD_BL
...
#if (BIND_SENSOR_OV2643) || (BIND_SENSOR_CP8210)
...
#define GSENSOR_MODULE				(GSENSOR_MODULE_LIS3DH) //GSENSOR_MODULE_RT3000 / GSENSOR_MODULE_LIS3DH /
...
#define VR_VIDEO_TYPE              COMMON_VR_VIDEO_TYPE_AVI // (COMMON_VR_VIDEO_TYPE_3GP)
...
#define DEVICE_GPIO_SD_PLUG				(MMP_GPIO38)	// CGPIO6 --> SD_PR
#define DEVICE_GPIO_SD_POWER			(MMP_GPIO39)	// CGPIO7
...
#define USB_IN_DETECT_VBUS_PIN              (MMP_GPIO25)//B15
#define USB_IN_DETECT_VBUS_PIN_ACTIVE       (GPIO_LOW)
#define USB_DETECTION_CUSTOM                (0) //TBD
#ifdef MCR_V2_32MB
#define USB_OUT_PWR_SW_PIN                  (MMP_GPIO_MAX)
#else
#define USB_OUT_PWR_SW_PIN                  (MMP_GPIO52)//C20
#endif
#define USB_OUT_PWR_SW_PIN_ACTIVE           (GPIO_HIGH)
...
#define HDMI_SINGLE_OSD_BUF			(HDMI_ENABLE & 1)

//#define TV_ONLY
#define TVOUT_ENABLE                (defined(TV_ONLY) | 1)
...
#define TV_OUT_DETECT_GPIO          (MMP_GPIO26)//(MMP_GPIO100)
...
#define TOUCH_PANEL_INT_GPIO                    (MMP_GPIO59)
#endif
...
#define ADC_KEY_VOLT_U              (1600)
#define ADC_KEY_VOLT_D              (2430)
...
#define ADC_STATE_ID_MODE           (ADCPRESS_NONE)
...
#define ADC_KEY_VOLT_MARGIN         (100)
...
#define KEY_GPIO_MENU               (MMP_GPIO101)   // PI2S_SDO         -->> MENU_KEY
#define KEY_GPIO_PLAY               (MMP_GPIO_MAX)
#define KEY_GPIO_MODE               (MMP_GPIO82)    // MIPI_RX1_DA2P    -->> MODE_KKEY
#define KEY_GPIO_POWER              (MMP_GPIO40)    // CGPIO8           ---> PWR_KEY_IN
...
#define KEY_GPIO_LEFT               (MMP_GPIO83)    // MIPI_RX1_CKN     -->> LEFT_KEY
#define KEY_GPIO_RIGHT              (MMP_GPIO81)    // MIPI_RX1_DA2N    -->> RIGHT_KEY
...
#define KEY_GPIO_MUTE               (MMP_GPIO_MAX)
...
#define KEY_PRESSLEVEL_MODE         LEVEL_LOW
#define KEY_PRESSLEVEL_POWER        LEVEL_HIGH//LEVEL_LOW

#define KEY_PRESSLEVEL_UP           LEVEL_LOW
#define KEY_PRESSLEVEL_DOWN         LEVEL_LOW
#define KEY_PRESSLEVEL_LEFT         LEVEL_LOW
#define KEY_PRESSLEVEL_RIGHT        LEVEL_LOW
