...
#define DISP_WIDTH					800//(320)
#define DISP_HEIGHT					480//(240)
...
//AHD
#define BIND_SENSOR_NVP6124B            (0)//AHD
...
#define SENSOR_GPIO_ENABLE              (MMP_GPIO20)
//#define SENSOR_GPIO_ENABLE_ACT_LEVEL    (PIO_HIGH)
#define SENSOR_GPIO_REAR_ENABLE         (MMP_GPIO21)
...
#define GSENSOR_MODULE				(GSENSOR_MODULE_LIS3DH)
...
#if (DUALENC_SUPPORT == 1) //Note: dual encode must be frame mode.
...
#define VR_VIDEO_CURBUF_ENCODE_MODE (COMMON_VR_VIDEO_CURBUF_FRAME)
#else
#if (HANDLE_JPEG_EVENT_BY_QUEUE == 1) && (USE_H264_CUR_BUF_AS_CAPT_BUF == 1)
#define VR_VIDEO_CURBUF_ENCODE_MODE (COMMON_VR_VIDEO_CURBUF_FRAME)
#else
#define VR_VIDEO_CURBUF_ENCODE_MODE (COMMON_VR_VIDEO_CURBUF_RT)
#endif
...
#define AHC_SEPAENC_SUPPORT (0)

#if (AHC_SEPAENC_SUPPORT)
...
#define VR_THUMBNAIL_JPG_ENABLE (1)
...
#define USB_OUT_PWR_SW_PIN                  (MMP_GPIO18)//B8
...
#define TOUCH_PANEL_INT_GPIO                    (MMP_GPIO52)
#endif
...
#define ADC_KEY_BOARD_TYPE          (0) //[0/1:V16/V17]

#define ADC_KEY_VOLT_U              (1019)    // 
#define ADC_KEY_VOLT_D              (436)     // 
#define ADC_KEY_VOLT_L              (288)
#define ADC_KEY_VOLT_R              (146)
...
#define ADC_KEY_VOLT_MARGIN         (ADC_KEY_BOARD_TYPE)? (50):(100)
#define ADC_KEY_VOLT_MARGIN_REC     (50)
...
#define KEY_GPIO_POWER 				(MMP_GPIO_MAX)//(MMP_GPIO40)//(MMP_GPIO_MAX) 	// CGPIO8 			---> PWR_KEY_IN
