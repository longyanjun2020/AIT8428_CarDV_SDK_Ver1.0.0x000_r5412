...
#define BIND_SENSOR_H42_MIPI            (1)//JX-H42
...
#define	TVDEC_USE_AHD_SENSOR_R			(1&&BIND_SENSOR_RN6750)||(1&&BIND_SENSOR_TP2825)
...
#define SHARERECD_FILE_LENGTH       (0x3200000)     // pre-allocate 50 MB space
#else
...
#define KEY_GPIO_FUNC1 				(MMP_GPIO101)	//pip SW
