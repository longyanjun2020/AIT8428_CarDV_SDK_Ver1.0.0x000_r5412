...
void User_LDWS_CalibrationParam_Convert(void)	
{
    ...
    usPreviewMode = MMPS_3GPRECD_GetPreviewMode();
...
void Menudraw_AutoLdwsCalibrationLines(UINT16 bID0)
{
	...
	ulOSD_W = STRETCH_W(ORIGINAL_OSD_W);
	ulOSD_H = STRETCH_H(ORIGINAL_OSD_H);
	usOsdLX = UserldwsTuningParms.laneCalibrationLeftPointX*ulOSD_W/UserldwsTuningParms.laneCalibrationImageWidth;
	usOsdLY = UserldwsTuningParms.laneCalibrationLeftPointY*ulOSD_H/UserldwsTuningParms.laneCalibrationImageHeight;
	usOsdRX = UserldwsTuningParms.laneCalibrationRightPointX*ulOSD_W/UserldwsTuningParms.laneCalibrationImageWidth;
	usOsdRY = UserldwsTuningParms.laneCalibrationRightPointY*ulOSD_H/UserldwsTuningParms.laneCalibrationImageHeight;
	usOsdUX = UserldwsTuningParms.laneCalibrationUpPointX*ulOSD_W/UserldwsTuningParms.laneCalibrationImageWidth;
	usOsdUY = UserldwsTuningParms.laneCalibrationUpPointY*ulOSD_H/UserldwsTuningParms.laneCalibrationImageHeight;

	AHC_OSDDrawLine(bID0, usOsdLX, usOsdRX, usOsdUY, usOsdUY);
