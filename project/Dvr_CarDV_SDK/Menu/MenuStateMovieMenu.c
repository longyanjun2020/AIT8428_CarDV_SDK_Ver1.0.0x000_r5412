...
AHC_BOOL MenuItemBluetoothUI_1(PSMENUITEM pItem, AHC_BOOL bIsHover);
AHC_BOOL MenuItemBluetoothUI_2(PSMENUITEM pItem, AHC_BOOL bIsHover);
AHC_BOOL MenuItemBluetoothUI_3(PSMENUITEM pItem, AHC_BOOL bIsHover);
...
extern SMENUITEM sItemStillQuality ;
...
//-----------------------------
SMENUSTRUCT sSubBluetoothUI;
SMENUSTRUCT sSubRadioFM;
SMENUSTRUCT sSubRadioAM;
SMENUSTRUCT sSubUSB;
SMENUSTRUCT sSubAUX;
SMENUSTRUCT sSubRGB;

SMENUSTRUCT sSubMovieVMDRecTime_1;
SMENUSTRUCT sSubMovieVMDRecTime_2;
SMENUSTRUCT sSubMovieVMDRecTime_3;
/*===========================================================================
 ...
 *===========================================================================*/ 
 #if 0 //long
//menu main    bmBluetooth_UI
SMENUITEM sItemBluetoothUI          		= { ITEMID_MOVIE_MODE, 			&BMICON_MENU_REC_MODE,    	NULL,			&sSubBluetoothUI, 0, 		 0, AHC_TRUE, NULL };
SMENUITEM sItemBluetoothUI_List     	= { ITEMID_MOVIE_MODE_FHD,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };

SMENUITEM sItemRadioFM          		= { ITEMID_MOVIE_MODE, 			&BMICON_MENU_REC_MODE,    	NULL,			&sSubRadioFM, 0, 		 0, AHC_TRUE, NULL };
SMENUITEM sItemRadioAM          		= { ITEMID_MOVIE_MODE, 			&BMICON_MENU_REC_MODE,    	NULL,			&sSubRadioAM, 0, 		 0, AHC_TRUE, NULL };
//SMENUITEM sItemRadioAM          		= { ITEMID_MOVIE_MODE, 			&BMICON_MENU_REC_MODE,    	NULL,			&sSubRadioAM, 0, 		 0, AHC_TRUE, NULL };

SMENUITEM sItemUSB          		= { ITEMID_MOVIE_MODE, 			&BMICON_MENU_REC_MODE,    	NULL,			&sSubUSB, 0, 		 0, AHC_TRUE, NULL };
SMENUITEM sItemUSB_List     	= { ITEMID_MOVIE_MODE_FHD,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };

SMENUITEM sItemAUX          		= { ITEMID_MOVIE_MODE, 			&BMICON_MENU_REC_MODE,    	NULL,			&sSubAUX, 0, 		 0, AHC_TRUE, NULL };
SMENUITEM sItemAUX_List     	= { ITEMID_MOVIE_MODE_FHD,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };

SMENUITEM sItemRGB          		= { ITEMID_MOVIE_RGB_MODE, 			&BMICON_MENU_REC_MODE,    	NULL,			&sSubRGB, 0, 		 0, AHC_TRUE, NULL };
SMENUITEM sItemRGB_List     	= { ITEMID_MOVIE_RGB_MODE_1,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };
SMENUITEM sItemRGB_List1     	= { ITEMID_MOVIE_RGB_MODE_2,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };
SMENUITEM sItemRGB_List2     	= { ITEMID_MOVIE_RGB_MODE_3,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };
SMENUITEM sItemRGB_List3     	= { ITEMID_MOVIE_RGB_MODE_4,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };
SMENUITEM sItemRGB_List4     	= { ITEMID_MOVIE_RGB_MODE_5,  	&BMICON_MOVIE_RES_SHD30P, 	NULL,		NULL, MenuItemBluetoothUI, 0, AHC_TRUE, NULL };
#endif
...
//add OSD
SMENUITEM sItemMovieQuality_Fine_FM1    	= { ITEMID_FM1, 		&BMICON_QUALITY_HQ,  IDS_DS_FM1,		NULL, MenuItemMovieQuality, 0, AHC_TRUE, NULL };

SMENUITEM sItemMovieQuality_Fine_FM2    	= { ITEMID_FM2, 		&BMICON_QUALITY_HQ,  IDS_DS_FM2,		NULL, MenuItemMovieQuality, 0, AHC_TRUE, NULL };
#if 1//lyj 20190216
SMENUITEM sItemMovieQuality_Fine_FM3    	= { ITEMID_FM3, 		NULL,  IDS_DS_FM2,		NULL, MenuItemMovieQuality, 0, AHC_TRUE, NULL };
SMENUITEM sItemMovieQuality_Fine_FM4    	= { ITEMID_FM4, 		NULL,  IDS_DS_FM2,		NULL, MenuItemMovieQuality, 0, AHC_TRUE, NULL };
#endif
#endif
#endif
...
SMENUITEM sItemMovieClipTime_off  		= { 0,	 	NULL, 	IDS_DS_OFF,				NULL, MenuItemMovieClipTime, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MOVIE_CLIP_TIME_6SEC_EN)
SMENUITEM sItemMovieClipTime_6sec      	= { 1, NULL, 	IDS_TIME_1MIN,			NULL, MenuItemMovieClipTime, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MOVIE_CLIP_TIME_1MIN_EN)
SMENUITEM sItemMovieClipTime_1min      	= { 1, 	NULL, 	IDS_TIME_1MIN,			NULL, MenuItemMovieClipTime, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MOVIE_CLIP_TIME_2MIN_EN)
SMENUITEM sItemMovieClipTime_2min      	= { 2, 	NULL, 	IDS_TIME_2MIN,			NULL, MenuItemMovieClipTime, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MOVIE_CLIP_TIME_3MIN_EN)
SMENUITEM sItemMovieClipTime_3min  		= { 3, 	NULL, 	IDS_TIME_3MIN,			NULL, MenuItemMovieClipTime, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MOVIE_CLIP_TIME_5MIN_EN)
SMENUITEM sItemMovieClipTime_5min       = { 4, 	NULL, 	IDS_TIME_5MIN,			NULL, MenuItemMovieClipTime, 0, AHC_TRUE, NULL };
#endif
...
SMENUITEM sItemMovieVMDRecTime      	= { ITEMID_MOVIE_VMD_REC_TIME, 	  	 NULL, 	IDS_VMD_REC_TIME, 	&sSubMovieVMDRecTime, 			0, 		   0, AHC_TRUE, NULL };
#if (MENU_MOVIE_VMD_REC_TIME_5SEC_EN)
SMENUITEM sItemMovieVMDRecTime_5sec 	= { 0,  NULL, 	IDS_TIME_5SEC,	NULL, MenuItemMovieVMDRecTime, 0, AHC_TRUE, NULL };

//add 
//SMENUITEM sItemMovieVMDRecTime_5sec_1	= {	ITEMID_MOVIE_VMD_REC_TIME_5SEC1,&BMICON_OFFTIME_5SEC,IDS_TIME_5SEC,	NULL, MenuItemBluetoothUI_1, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MOVIE_VMD_REC_TIME_10SEC_EN)
SMENUITEM sItemMovieVMDRecTime_10sec 	= { 1, NULL, IDS_TIME_10SEC,	 NULL, MenuItemMovieVMDRecTime, 0, AHC_TRUE, NULL };
//add lyj
//SMENUITEM sItemMovieVMDRecTime_10sec_1  = {ITEMID_MOVIE_VMD_REC_TIME_10SEC1, &BMICON_OFFTIME_10SEC, IDS_TIME_10SEC,	NULL, MenuItemBluetoothUI_2, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MOVIE_VMD_REC_TIME_30SEC_EN)
SMENUITEM sItemMovieVMDRecTime_30sec 	= { 2, NULL, IDS_TIME_30SEC,	NULL, MenuItemMovieVMDRecTime, 0, AHC_TRUE, NULL };

//SMENUITEM sItemMovieVMDRecTime_30sec_1  = {ITEMID_MOVIE_VMD_REC_TIME_30SEC1, &BMICON_OFFTIME_30SEC, IDS_TIME_30SEC,	NULL, MenuItemBluetoothUI_3, 0, AHC_TRUE, NULL };
#endif
...
#if 0 //long
PSMENUITEM sMenuListBluetoothUI[]=
{
    &sItemBluetoothUI_List,

};
PSMENUITEM sMenuListUSB[]=
{
    &sItemUSB_List,

};
PSMENUITEM sMenuListAUX[]=
{
    &sItemAUX_List,

};
PSMENUITEM sMenuListRGB[]=
{
    &sItemRGB_List,
    &sItemRGB_List1,
    &sItemRGB_List2,
...
PSMENUITEM   sMenuListMovieQuality[] =
{
    ...
    &sItemMovieQuality_Fine_FM1,
    &sItemMovieQuality_Fine_FM2,
    #if 1 // lyj 20190216
	 &sItemMovieQuality_Fine_FM3,
    &sItemMovieQuality_Fine_FM4
	#endif
...
#if 0
PSMENUITEM sMenuListMovieVMDRecTime_5sec[]=
{
    &sItemMovieVMDRecTime_5sec_1,

};

PSMENUITEM sMenuListMovieVMDRecTime_10sec[]=
{
    &sItemMovieVMDRecTime_10sec_1,

};

PSMENUITEM sMenuListMovieVMDRecTime_30sec[]=
{
    &sItemMovieVMDRecTime_30sec_1,
...
#if(1)
{
	&sItemMovieMode,//sItemBluetoothUI,// 0
	
	&sItemMovieQuality,//sItemRadioFM,// 1
	&sItemBeep,// 2
	&sItemMovieVMDRecTime,// 3
	//&sItemStillQuality,// 4
	&sItemStillImageSize,// 5
	&sItemISO,//sItemAUX,// 6 
	&sItemMICSensitivity,//sItemUSB, // 7
	&sItemMovieClipTime,//sItemRGB,// 8
	&sItemContrast,// 9
...
SMENUSTRUCT sSubBluetoothUI =
{
    ...
    IDS_DS_MOVIE_MODE,
    NULL,
    sizeof(sMenuListBluetoothUI)/sizeof(PSMENUITEM),// 
    sMenuListBluetoothUI,
    SubMenuEventHandler,
...
SMENUSTRUCT sSubRadioFM =
{
    ...
    IDS_DS_MOVIE_MODE,
    NULL,
    sizeof(sMenuListMovieQuality)/sizeof(PSMENUITEM),// sMenuListBluetoothUI
...
SMENUSTRUCT sSubUSB =
{
    ...
    IDS_DS_MOVIE_MODE,
    NULL,
    sizeof(sMenuListUSB)/sizeof(PSMENUITEM),// 
    sMenuListUSB,
    SubMenuEventHandler,
    MenuGetDefault_Movie,
    0,
...
SMENUSTRUCT sSubAUX =
{
    ...
    IDS_DS_MOVIE_MODE,
    NULL,
    sizeof(sMenuListAUX)/sizeof(PSMENUITEM),// 
    sMenuListAUX,
    SubMenuEventHandler,
    MenuGetDefault_Movie,
    0,
...
SMENUSTRUCT sSubRGB =
{
    ...
    IDS_DS_MOVIE_MODE,
    NULL,
    sizeof(sMenuListRGB)/sizeof(PSMENUITEM),// 
    sMenuListRGB,
    SubMenuEventHandler,
    MenuGetDefault_Movie,
    0,
...
SMENUSTRUCT sSubMovieVMDRecTime_1 =
{
	...
	IDS_VMD_REC_TIME,	
    NULL,
    sizeof(sMenuListMovieVMDRecTime_5sec)/sizeof(PSMENUITEM),
    sMenuListMovieVMDRecTime_5sec,
    SubMenuEventHandler1,
    MenuGetDefault_Movie,
    0, 
	IDS_VMD_REC_TIME,
    AHC_FALSE,
...
SMENUSTRUCT sSubMovieVMDRecTime_2 =
{
	...
	IDS_VMD_REC_TIME,	
    NULL,
    sizeof(sMenuListMovieVMDRecTime_10sec)/sizeof(PSMENUITEM),
    sMenuListMovieVMDRecTime_5sec,
    SubMenuEventHandler1,
    MenuGetDefault_Movie,
    0, 
...
SMENUSTRUCT sSubMovieVMDRecTime_3 =
{
	...
	IDS_VMD_REC_TIME,	
    NULL,
    sizeof(sMenuListMovieVMDRecTime_30sec)/sizeof(PSMENUITEM),
    sMenuListMovieVMDRecTime_5sec,
    SubMenuEventHandler1,
    MenuGetDefault_Movie,
    0, 
...
AHC_BOOL MenuItemBluetoothUI_1(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
	...
	MenuSettingConfig()->uiVMDRecTime = pItem->iItemId - ITEMID_MOVIE_VMD_REC_TIME_5SEC -1;
    return AHC_TRUE;
}
...
AHC_BOOL MenuItemBluetoothUI_2(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
	...
	MenuSettingConfig()->uiVMDRecTime = pItem->iItemId - ITEMID_MOVIE_VMD_REC_TIME_10SEC -1;
    return AHC_TRUE;
}
...
AHC_BOOL MenuItemBluetoothUI_3(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
	...
	MenuSettingConfig()->uiVMDRecTime = pItem->iItemId - ITEMID_MOVIE_VMD_REC_TIME_30SEC -1;
    return AHC_TRUE;
}
#if (MENU_MOVIE_SIZE_EN) 
AHC_BOOL MenuItemMovieMode(PSMENUITEM pItem, AHC_BOOL bIsHover)
...
AHC_BOOL MenuItemMovieQuality(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
	...
	printc("~~~~~~FM~~~~~~~uiMOVQuality = %d", MenuSettingConfig()->uiMOVQuality);
...
AHC_BOOL MenuItemMovieClipTime(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
	MenuSettingConfig()->uiMOVClipTime = pItem->iItemId;
	return AHC_TRUE;
}
#endif
...
AHC_BOOL MenuItemMovieVMDRecTime(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
	MenuSettingConfig()->uiVMDRecTime = pItem->iItemId;
	printc("~~~~~~~~~~MenuItemMovieVMDRecTime~~~~~~~~~~\r\n");
...
//=================lyj 20191018============
		eError = SDUpdateCheckFileExisted(SD_FW_UPDATER_BIN_MASS_NAME);
	if(eError != SD_UPDATER_ERR_FILE) {
	printc(FG_YELLOW("Update SD:\\SD_CarDV_MASS.bin success!\r\n"));      
		 }
...
//======================================
	...
	if(eError != SD_UPDATER_ERR_FILE)
	{
		...
		// Update Success
		//uiPowerOffPicture(); // lyj 20190815
		AHC_PMU_PowerOff();
    }
}
#endif
...
AHC_BOOL MenuStateVideoModeInit(void* pData)
{
  ...
  extern AHC_BOOL PowerOnVoiceMode; // lyj 20190622
  extern MMP_USHORT radio[31]; // lyj 20190627
extern MMP_USHORT radio_am[21];
//extern AHC_BOOL 			return_flag;
extern AHC_BOOL displayFreqflag;
extern AHC_BOOL displayFreqflagAM;
...
#else
	printc("~~~~~~~~~~~~~long~~~~debug~~\r\n"); //long 4 -27
    SetCurrentMenu(&sMainMenuVideo);//设定主菜单
#endif
#if 0 // lyj 20190606
	//if(PowerOnFlag.Fm == 1 )// lyj 20190605
	if(MenuSettingConfig()->uiPowerUpFlag == 1)
	{
		Menu_Set_Page(1);
    ...
    #endif
	switch(MenuSettingConfig()->uiPowerUpFlag)
	{
		case 1:
			if(radio[1] !=0)
				displayFreqflag = 1;
			Menu_Set_Page(1);
			MenuStateExecutionCommon1(1);
			PowerOnVoiceMode = 4; // lyj 20190622
			break;
		case 2:
			if(radio_am[1] !=0)
				displayFreqflagAM = 1;
			...
			PowerOnVoiceMode = 5; // lyj 20190622
			break;
		case 3:
			Menu_Set_Page(5);
			MenuStateExecutionCommon1(5);
			//AHC_OS_SleepMs(50);
			//IIC_write_data(0x04,0x01,1);// AUX
			PowerOnVoiceMode = 2; // lyj 20190622
			break;
		case 4:
			PowerOnVoiceMode =7;
			Menu_Set_Page(6);
		...
		//	converseChannel(0xF3);
			...
			//	Set_flag(2);
				...
				PowerOnVoiceMode = 1; // lyj 20190622
			printc("~~~~~~^_^~~~~u2224~~~~~~~~~~~~~~~\n");
			break;
		case 5:
			Menu_Set_Page(0);
			MenuStateExecutionCommon1(0);
			PowerOnVoiceMode = 3; // lyj 20190622
			//AHC_OS_SleepMs(50);
