...
SMENUITEM sItemStillImageSize_8M       = { 0,   NULL,  	IDS_DS_IMAGE_SIZE_8M,	NULL, MenuItemStillImageSize, 0, AHC_TRUE, NULL };
#endif
#if (MENU_STILL_SIZE_5M_EN)
SMENUITEM sItemStillImageSize_5M       = { 1,   NULL,  	IDS_DS_IMAGE_SIZE_5M,	NULL, MenuItemStillImageSize, 0, AHC_TRUE, NULL };
#endif
#if (MENU_STILL_SIZE_3M_EN)
SMENUITEM sItemStillImageSize_3M       = { 2,   NULL,  	IDS_DS_IMAGE_SIZE_3M,	NULL, MenuItemStillImageSize, 0, AHC_TRUE, NULL };
#endif
#if (MENU_STILL_SIZE_2M_WIDE_EN)
SMENUITEM sItemStillImageSize_2M_Wide  = { 3,   NULL,   	IDS_DS_IMAGE_SIZE_2M,	NULL, MenuItemStillImageSize, 0, AHC_TRUE, NULL };
#endif
#if (MENU_STILL_SIZE_1d2M_EN)
SMENUITEM sItemStillImageSize_1_2M     = { 4, NULL, 	IDS_DS_IMAGE_SIZE_1_2M,	NULL, MenuItemStillImageSize, 0, AHC_TRUE, NULL };
#endif
#if (MENU_STILL_SIZE_VGA_EN)
SMENUITEM sItemStillImageSize_VGA      = { 5,  NULL, 	IDS_DS_IMAGE_SIZE_VGA,	NULL, MenuItemStillImageSize, 0, AHC_TRUE, NULL };
#endif
#endif
...
AHC_BOOL MenuItemStillImageSize(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
    MenuSettingConfig()->uiIMGSize = pItem->iItemId;
