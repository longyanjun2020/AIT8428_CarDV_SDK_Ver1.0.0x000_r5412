...
void DrawSubItem(UINT16 uwDisplayID, int iItem, int iTotalItems, UINT8 uLang, UINT32 iStrID, GUI_BITMAP IconID, UINT32 barState, GUI_COLOR colorFont,GUI_COLOR ColorBack, GUI_COLOR colorSelect);
...
void MenuDrawChangeSubItem1(PSMENUSTRUCT pMenu, UINT32 uiCurrItem, UINT32 uiPrevItem, UINT32 uiPreSelected);//long
