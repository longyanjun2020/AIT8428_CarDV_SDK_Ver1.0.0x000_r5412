...
void LDWS_CalibrationParam_Inverse(ldws_tuning_params ldws_tuning_params)
{
    MMP_ULONG width, height;
    MMP_ULONG offsetX = 0, offsetY = 0;

    MMPS_3GPRECD_GetPreviewRes(PRM_SENSOR, &width, &height);
				
    if(menu_ldws_tuning_params.laneCalibrationImageWidth >= width)
    {
    	offsetX = (menu_ldws_tuning_params.laneCalibrationImageWidth - width) / 2;
    }
	
    if(menu_ldws_tuning_params.laneCalibrationImageHeight >= height)
    {
	...
	{
	    menu_ldws_tuning_params.laneCalibrationUpPointX = ldws_tuning_params.laneCalibrationUpPointX * width/ldws_tuning_params.laneCalibrationImageWidth/OSD_DISPLAY_SCALE_LCD;// + offsetX;
	    menu_ldws_tuning_params.laneCalibrationUpPointY = ldws_tuning_params.laneCalibrationUpPointY * height/ldws_tuning_params.laneCalibrationImageHeight/OSD_DISPLAY_SCALE_LCD;// + offsetY;
		menu_ldws_tuning_params.laneCalibrationLeftPointX = ldws_tuning_params.laneCalibrationLeftPointX * width/ldws_tuning_params.laneCalibrationImageWidth/OSD_DISPLAY_SCALE_LCD;// + offsetX;
		menu_ldws_tuning_params.laneCalibrationLeftPointY = ldws_tuning_params.laneCalibrationLeftPointY * height/ldws_tuning_params.laneCalibrationImageHeight/OSD_DISPLAY_SCALE_LCD;// + offsetY;
		menu_ldws_tuning_params.laneCalibrationRightPointX = ldws_tuning_params.laneCalibrationRightPointX * width/ldws_tuning_params.laneCalibrationImageWidth/OSD_DISPLAY_SCALE_LCD;// + offsetX;
		menu_ldws_tuning_params.laneCalibrationRightPointY = ldws_tuning_params.laneCalibrationRightPointY * height/ldws_tuning_params.laneCalibrationImageHeight/OSD_DISPLAY_SCALE_LCD;// + offsetY;
	}
	else
	{
    ...
    case LDWS_CALIB_INIT:
		...
		if (MMP_ERR_NONE == MMPS_FS_FileOpen(LDWS_CALIBRATION_FILENAME, strlen(LDWS_CALIBRATION_FILENAME), "rb", strlen("rb"), &ulFileId))
		{
			...
			if ((MMP_ERR_NONE == err) && (ulTurningParamlSize == sizeof(ldws_tuning_params)))
			{
				...
				LDWS_CalibrationParam_Inverse(templdwsTuningParms);
			}
