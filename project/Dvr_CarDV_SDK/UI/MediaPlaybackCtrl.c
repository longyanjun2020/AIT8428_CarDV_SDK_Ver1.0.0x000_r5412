...
void JpgPlaybackSetOutputDev(AHC_DISPLAY_OUTPUTPANEL Device)
{
    ...
    switch(Device)
    {
...
#if (VERTICAL_LCD == VERTICAL_LCD_DEGREE_0)
	        AHC_SetDisplayWindow(DISPLAY_SYSMODE_STILLPLAYBACK, AHC_TRUE, AHC_FALSE, 0, 0, RTNA_LCD_GetAttr()->usPanelW, RTNA_LCD_GetAttr()->usPanelH, 0);
#elif (VERTICAL_LCD == VERTICAL_LCD_DEGREE_90) || (VERTICAL_LCD == VERTICAL_LCD_DEGREE_270)
	        AHC_SetDisplayWindow(DISPLAY_SYSMODE_STILLPLAYBACK, AHC_TRUE, AHC_TRUE,  0, 0, RTNA_LCD_GetAttr()->usPanelW, RTNA_LCD_GetAttr()->usPanelH, 0);
#endif
	    break;
	    ...
	    case AHC_DISPLAY_HDMI:
            ...
            switch(HdmiMode){
                case AHC_DISPLAY_HDMIOUTPUT_1920X1080P:
                    AHC_SetDisplayWindow(DISPLAY_SYSMODE_STILLPLAYBACK, AHC_FALSE, AHC_FALSE, 0, 0, Width, Height, 0);
                    break;
                case AHC_DISPLAY_HDMIOUTPUT_1920X1080I:
                    AHC_SetDisplayWindow(DISPLAY_SYSMODE_STILLPLAYBACK, AHC_FALSE, AHC_FALSE, 0, 0, Width, Height<<1, 0);
                    break;
	    ...
	    case AHC_DISPLAY_NTSC_TV:
			...
			AHC_SetDisplayWindow(DISPLAY_SYSMODE_STILLPLAYBACK, AHC_FALSE, AHC_FALSE, 0, 0, Width, Height-20, 0);
	    break;

	    case AHC_DISPLAY_PAL_TV:
	        AHC_GetPalTvDisplayWidthHeight(&Width, &Height);
			AHC_SetDisplayWindow(DISPLAY_SYSMODE_STILLPLAYBACK, AHC_FALSE, AHC_FALSE, 0, 0, Width-30, Height-20, 0);
	    break;
    }
}
...
void MovPlaybackSetOutputDev(AHC_DISPLAY_OUTPUTPANEL Device)
{
    ...
    switch(Device)
    {
	    case AHC_DISPLAY_MAIN_LCD:
#if (VERTICAL_LCD == VERTICAL_LCD_DEGREE_0)
	        AHC_SetDisplayWindow(DISPLAY_SYSMODE_VIDEOPLAYBACK, AHC_FALSE, AHC_FALSE, 0, 0, RTNA_LCD_GetAttr()->usPanelW, RTNA_LCD_GetAttr()->usPanelH, 0);
#elif (VERTICAL_LCD == VERTICAL_LCD_DEGREE_90) || (VERTICAL_LCD == VERTICAL_LCD_DEGREE_270)
	        AHC_SetDisplayWindow(DISPLAY_SYSMODE_VIDEOPLAYBACK, AHC_FALSE, AHC_TRUE,  0, 0, RTNA_LCD_GetAttr()->usPanelW, RTNA_LCD_GetAttr()->usPanelH, 0);
#endif
	    break;

	    case AHC_DISPLAY_HDMI:
	        AHC_GetHdmiDisplayWidthHeight(&Width, &Height);
	        AHC_SetDisplayWindow(DISPLAY_SYSMODE_VIDEOPLAYBACK, AHC_FALSE, AHC_FALSE, 0, 0, Width, Height, 0);
	    break;
